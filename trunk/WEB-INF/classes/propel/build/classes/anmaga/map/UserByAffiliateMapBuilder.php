 ...
 * @package anmaga.map
 */
class UserByAffiliateMapBuilder implements MapBuilder {
    ...
    public function doBuild()
    {
		...
		// Add columns to map
		$tMap->addForeignPrimaryKey("ID", "Id", "int" , CreoleTypes::INTEGER, "usersByAffiliate_userInfo", "USERID", true);
		...
		$tMap->addForeignKey("LEVELID", "Levelid", "int", CreoleTypes::INTEGER, "usersByAffiliate_level" , "ID", false);
