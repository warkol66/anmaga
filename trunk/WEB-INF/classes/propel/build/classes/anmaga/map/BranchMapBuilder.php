...
/**
 * This class adds structure of 'branch' table to 'anmaga' DatabaseMap object.
 *
 *
 ...
 * @package    anmaga.map
 */
class BranchMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'anmaga.map.BranchMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('branch');
		$tMap->setPhpName('Branch');
		...
		$tMap->addColumn('CODE', 'Code', 'string', CreoleTypes::VARCHAR, false, 20);
