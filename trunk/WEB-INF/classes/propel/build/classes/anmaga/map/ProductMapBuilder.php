...
class ProductMapBuilder implements MapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addForeignKey("UNITID", "Unitid", "int", CreoleTypes::INTEGER, "unit" , "ID", false);
		$tMap->addForeignKey("MEASUREUNITID", "Measureunitid", "int", CreoleTypes::INTEGER, "measureUnit" , "ID", false);
