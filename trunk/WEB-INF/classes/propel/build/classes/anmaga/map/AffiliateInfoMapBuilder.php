...
class AffiliateInfoMapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addForeignPrimaryKey('AFFILIATEID', 'Affiliateid', 'int' , CreoleTypes::INTEGER, 'affiliate', 'ID', true, null);

		$tMap->addColumn('AFFILIATEINTERNALNUMBER', 'Affiliateinternalnumber', 'int', CreoleTypes::INTEGER, true);
		...
		$tMap->addColumn('CONTACT', 'Contact', 'string', CreoleTypes::VARCHAR, false);
