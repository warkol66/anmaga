<?php
require_once 'om/BaseUsersByAffiliateGroup.php';
 ...
 * @package anmaga 
 */
class UsersByAffiliateGroup extends BaseUsersByAffiliateGroup {
  ...
  */
  function getCategories() {
		$cond = new Criteria();
		$cond->add(UsersByAffiliateGroupCategoryPeer::GROUPID, $this->getId());
