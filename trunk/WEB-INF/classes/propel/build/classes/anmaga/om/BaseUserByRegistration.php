...
include_once 'anmaga/UserByRegistrationPeer.php';
...
abstract class BaseUserByRegistration extends BaseObject  implements Persistent {
	 ...
	 */
	protected $aUserByRegistrationInfo;

	/**
	 * Collection to store aggregation of collUserByRegistrationInfos.
	 * @var        array
	 */
	protected $collUserByRegistrationInfos;

	/**
	 * The criteria used to select the current contents of collUserByRegistrationInfos.
	 * @var        Criteria
	 */
	protected $lastUserByRegistrationInfoCriteria = null;
	...
	public function setId($v)
	{
		...
		if ($this->aUserByRegistrationInfo !== null && $this->aUserByRegistrationInfo->getUserid() !== $v) {
			$this->aUserByRegistrationInfo = null;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->ip = $rs->getString($startcol + 6);
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			UserByRegistrationPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUserByRegistrationInfo !== null) {
				if ($this->aUserByRegistrationInfo->isModified()) {
					$affectedRows += $this->aUserByRegistrationInfo->save($con);
				}
				$this->setUserByRegistrationInfo($this->aUserByRegistrationInfo);
			}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = UserByRegistrationPeer::doInsert($this, $con);
			...
			if ($this->collUserByRegistrationInfos !== null) {
				foreach($this->collUserByRegistrationInfos as $referrerFK) {
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUserByRegistrationInfo !== null) {
				if (!$this->aUserByRegistrationInfo->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUserByRegistrationInfo->getValidationFailures());
				}
			}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		if ($deepCopy) {
			...
			foreach($this->getUserByRegistrationInfos() as $relObj) {
				$copyObj->addUserByRegistrationInfo($relObj->copy($deepCopy));
			}
	 ...
	 * @throws     PropelException
	 */
	public function setUserByRegistrationInfo($v)
	{
		...
		$this->aUserByRegistrationInfo = $v;
	}
	 ...
	 * @throws     PropelException
	 */
	public function getUserByRegistrationInfo($con = null)
	{
		// include the related Peer class
		include_once 'anmaga/om/BaseUserByRegistrationInfoPeer.php';

		if ($this->aUserByRegistrationInfo === null && ($this->id !== null)) {

			$this->aUserByRegistrationInfo = UserByRegistrationInfoPeer::retrieveByPK($this->id, $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   never be used.
			   $obj = UserByRegistrationInfoPeer::retrieveByPK($this->id, $con);
			   $obj->addUserByRegistrationInfos($this);
			 */
		}
		return $this->aUserByRegistrationInfo;
	}

	/**
	 * Temporary storage of collUserByRegistrationInfos to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	public function initUserByRegistrationInfos()
	{
		if ($this->collUserByRegistrationInfos === null) {
			$this->collUserByRegistrationInfos = array();
		}
	}
	 ...
	 * Otherwise if this UserByRegistration has previously
	 * been saved, it will retrieve related UserByRegistrationInfos from storage.
	 * If this UserByRegistration is new, it will return
	 ...
	 * @throws     PropelException
	 */
	public function getUserByRegistrationInfos($criteria = null, $con = null)
	{
		...
		if ($this->collUserByRegistrationInfos === null) {
			if ($this->isNew()) {
			   $this->collUserByRegistrationInfos = array();
				...
				$criteria->add(UserByRegistrationInfoPeer::USERID, $this->getId());

				UserByRegistrationInfoPeer::addSelectColumns($criteria);
				$this->collUserByRegistrationInfos = UserByRegistrationInfoPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				UserByRegistrationInfoPeer::addSelectColumns($criteria);
				if (!isset($this->lastUserByRegistrationInfoCriteria) || !$this->lastUserByRegistrationInfoCriteria->equals($criteria)) {
					$this->collUserByRegistrationInfos = UserByRegistrationInfoPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastUserByRegistrationInfoCriteria = $criteria;
		return $this->collUserByRegistrationInfos;
	}

	/**
	 * Returns the number of related UserByRegistrationInfos.
	 *
	 * @param      Criteria $criteria
	 ...
	 * @throws     PropelException
	 */
	public function countUserByRegistrationInfos($criteria = null, $distinct = false, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseUserByRegistrationInfoPeer.php';
		if ($criteria === null) {
		...
		return UserByRegistrationInfoPeer::doCount($criteria, $distinct, $con);
	}

	/**
	 * Method called to associate a UserByRegistrationInfo object to this object
	 * through the UserByRegistrationInfo foreign key attribute
	 *
	 * @param      UserByRegistrationInfo $l UserByRegistrationInfo
	 * @return     void
	 * @throws     PropelException
	 */
	public function addUserByRegistrationInfo(UserByRegistrationInfo $l)
	{
		$this->collUserByRegistrationInfos[] = $l;
		$l->setUserByRegistration($this);
	}
