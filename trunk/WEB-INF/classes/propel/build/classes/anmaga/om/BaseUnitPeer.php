...
abstract class BaseUnitPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(UnitMapBuilder::CLASS_NAME);
	}
	 ...
	 * @param Connection $con
	 * @return Unit	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or Unit object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(UnitMapBuilder::CLASS_NAME);
}
