...
abstract class BaseUnitPeer {
	...
	const CLASS_DEFAULT = 'anmaga.Unit';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (UnitPeer::ID, UnitPeer::NAME, UnitPeer::UNITQUANTITY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (UnitPeer::ID => 0, UnitPeer::NAME => 1, UnitPeer::UNITQUANTITY => 2, ),
	...
	{
		include_once 'anmaga/map/UnitMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.UnitMapBuilder');
	}
	/**
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(UnitPeer::ID); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/UnitMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.UnitMapBuilder');
}
