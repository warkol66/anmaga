...
abstract class BaseOrderPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(OrderMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::PROCESSED);
		$criteria->addSelectColumn(self::TOTAL);
		$criteria->addSelectColumn(self::STATE);
	}
	 ...
	 * @param Connection $con
	 * @return Order	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or Order object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of Order objects pre-filled with their
	...
	/**
	 * Selects a collection of Order objects pre-filled with
	 * all related objects.
	 *
	 * @return array Array of Order objects.
	 * @throws PropelException Any exceptions caught during processing will be
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(OrderMapBuilder::CLASS_NAME);
}
