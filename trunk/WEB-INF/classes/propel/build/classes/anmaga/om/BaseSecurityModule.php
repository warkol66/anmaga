...
abstract class BaseSecurityModule extends BaseObject  implements Persistent {
	...
	public function setAccessusersbyaffiliate($v)
	{
		...
		if ($this->accessusersbyaffiliate !== $v) {
			...
			$this->modifiedColumns[] = SecurityModulePeer::ACCESSUSERSBYAFFILIATE;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->accessusersbyaffiliate = $rs->getInt($startcol + 2);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SecurityModulePeer::ACCESSUSERSBYAFFILIATE)) $criteria->add(SecurityModulePeer::ACCESSUSERSBYAFFILIATE, $this->accessusersbyaffiliate);
