...
abstract class BaseUserByAffiliate extends BaseObject implements Persistent {
	 ...
	 */
	public function getUserInfosJoinUserByAffiliate($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/UserInfoPeer.php';
		if ($criteria === null) {
		...
		if ($this->collUserInfos === null) {
			if ($this->isNew()) {
			   $this->collUserInfos = array();
				...
				$criteria->add(UserInfoPeer::USERID, $this->getId());
				$this->collUserInfos = UserInfoPeer::doSelectJoinUserByAffiliate($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in UserByAffiliate.
	 */
	public function getUserGroupsJoinUserByAffiliate($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/UserGroupPeer.php';
		if ($criteria === null) {
		...
		if ($this->collUserGroups === null) {
			if ($this->isNew()) {
			   $this->collUserGroups = array();
				...
				$criteria->add(UserGroupPeer::USERID, $this->getId());
				$this->collUserGroups = UserGroupPeer::doSelectJoinUserByAffiliate($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
