...
abstract class BaseAffiliate extends BaseObject  implements Persistent {
	 ...
	 * @var        Criteria
	 */
	protected $lastBranchCriteria = null;
	...
	public function getAffiliateInfo($con = null)
	{
		...
		include_once 'anmaga/om/BaseAffiliateInfoPeer.php';
	 ...
	 * actually need in Affiliate.
	 */
	public function getOrdersJoinAffiliateUser($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseOrderPeer.php';
		if ($criteria === null) {
		...
		if ($this->collOrders === null) {
			if ($this->isNew()) {
				...
				$this->collOrders = OrderPeer::doSelectJoinAffiliateUser($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
		...
		if ($this->collOrderStateChanges === null) {
			if ($this->isNew()) {
			   $this->collOrderStateChanges = array();
				...
				$criteria->add(OrderStateChangePeer::AFFILIATEID, $this->getId());
	 ...
	 * actually need in Affiliate.
	 */
	public function getOrderTemplatesJoinAffiliateUser($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseOrderTemplatePeer.php';
		if ($criteria === null) {
		...
		if ($this->collOrderTemplates === null) {
			if ($this->isNew()) {
				...
				$this->collOrderTemplates = OrderTemplatePeer::doSelectJoinAffiliateUser($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Returns the number of related Branchs.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      Connection $con
	 * @throws     PropelException
	 */
	public function countBranchs($criteria = null, $distinct = false, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseBranchPeer.php';
		if ($criteria === null) {
		...
		return BranchPeer::doCount($criteria, $distinct, $con);
	}
