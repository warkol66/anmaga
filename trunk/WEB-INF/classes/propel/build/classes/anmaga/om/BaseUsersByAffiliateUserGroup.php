...
abstract class BaseUsersByAffiliateUserGroup extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 2; // 2 = UsersByAffiliateUserGroupPeer::NUM_COLUMNS - UsersByAffiliateUserGroupPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += UsersByAffiliateUserGroupPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UsersByAffiliateUserGroupPeer::doValidate($this, $columns)) !== true) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of UsersByAffiliateUserGroup (or compatible) type.
