...
abstract class BaseActionLogPeer {
	...
	const DATABASE_NAME = 'mer';

	/** the table name for this class */
	const TABLE_NAME = 'log_actionLog';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'mer.ActionLog';
	...
	{
		include_once 'mer/map/ActionLogMapBuilder.php';
		return BasePeer::getMapBuilder('mer.map.ActionLogMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'mer/map/ActionLogMapBuilder.php';
	Propel::registerMapBuilder('mer.map.ActionLogMapBuilder');
}
