...
abstract class BaseActionLogPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(ActionLogMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::DATETIME);
		$criteria->addSelectColumn(self::ACTION);
		$criteria->addSelectColumn(self::MESSAGE);
	}
	 ...
	 * @param Connection $con
	 * @return ActionLog	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or ActionLog object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of ActionLog objects pre-filled with their
	 * User objects.
	 *
	...
	public static function doSelectJoinSecurityAction(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getSecurityAction();
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addActionLog($obj1);
					break;
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(ActionLogMapBuilder::CLASS_NAME);
}
