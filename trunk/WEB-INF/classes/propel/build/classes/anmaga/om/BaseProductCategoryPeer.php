...
// actual class may be a subclass -- as returned by ProductCategoryPeer::getOMClass()
include_once 'anmaga/ProductCategory.php';
...
abstract class BaseProductCategoryPeer {
	...
	const CLASS_DEFAULT = 'anmaga.ProductCategory';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (ProductCategoryPeer::ID, ProductCategoryPeer::DESCRIPTION, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (ProductCategoryPeer::ID => 0, ProductCategoryPeer::DESCRIPTION => 1, ),
	...
	{
		include_once 'anmaga/map/ProductCategoryMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.ProductCategoryMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(productCategory.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT productCategory.ID)';
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(ProductCategoryPeer::ID); // remove pkey col since this table uses auto-increment
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof ProductCategory) {
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/ProductCategoryMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.ProductCategoryMapBuilder');
}
