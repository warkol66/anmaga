...
// actual class may be a subclass -- as returned by OrderTemplatePeer::getOMClass()
include_once 'anmaga/OrderTemplate.php';
...
abstract class BaseOrderTemplatePeer {
	...
	const CLASS_DEFAULT = 'anmaga.OrderTemplate';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (OrderTemplatePeer::ID, OrderTemplatePeer::NAME, OrderTemplatePeer::CREATED, OrderTemplatePeer::USERID, OrderTemplatePeer::AFFILIATEID, OrderTemplatePeer::BRANCHID, OrderTemplatePeer::TOTAL, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (OrderTemplatePeer::ID => 0, OrderTemplatePeer::NAME => 1, OrderTemplatePeer::CREATED => 2, OrderTemplatePeer::USERID => 3, OrderTemplatePeer::AFFILIATEID => 4, OrderTemplatePeer::BRANCHID => 5, OrderTemplatePeer::TOTAL => 6, ),
	...
	{
		include_once 'anmaga/map/OrderTemplateMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.OrderTemplateMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = OrderTemplatePeer::getTableMap();
	...
	const COUNT = 'COUNT(orders_orderTemplate.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT orders_orderTemplate.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(OrderTemplatePeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(OrderTemplatePeer::COUNT);
		}
		...
		$rs = OrderTemplatePeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return OrderTemplatePeer::populateObjects(OrderTemplatePeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function populateObjects(ResultSet $rs)
	{
		...
		$cls = OrderTemplatePeer::getOMClass();
	...
	public static function doCountJoinUserByAffiliate(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(OrderTemplatePeer::USERID, UserByAffiliatePeer::ID);
	...
	public static function doCountJoinAffiliate(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(OrderTemplatePeer::AFFILIATEID, AffiliatePeer::ID);
	...
	public static function doCountJoinBranch(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(OrderTemplatePeer::BRANCHID, BranchPeer::ID);
	...
	/**
	 * Selects a collection of OrderTemplate objects pre-filled with their UserByAffiliate objects.
	 *
	...
	public static function doSelectJoinUserByAffiliate(Criteria $c, $con = null)
	{
		...
		OrderTemplatePeer::addSelectColumns($c);
		$startcol = (OrderTemplatePeer::NUM_COLUMNS - OrderTemplatePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		UserByAffiliatePeer::addSelectColumns($c);

		$c->addJoin(OrderTemplatePeer::USERID, UserByAffiliatePeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = OrderTemplatePeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addOrderTemplate($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initOrderTemplates();
				$obj2->addOrderTemplate($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinAffiliate(Criteria $c, $con = null)
	{
		...
		$c->addJoin(OrderTemplatePeer::AFFILIATEID, AffiliatePeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinBranch(Criteria $c, $con = null)
	{
		...
		$c->addJoin(OrderTemplatePeer::BRANCHID, BranchPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getBranch(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addOrderTemplate($obj1); //CHECKME
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		OrderTemplatePeer::addSelectColumns($c);
		$startcol2 = (OrderTemplatePeer::NUM_COLUMNS - OrderTemplatePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		BranchPeer::addSelectColumns($c);
		$startcol5 = $startcol4 + BranchPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addOrderTemplate($obj1); // CHECKME
					break;
				}
			}
			
			if ($newObject) {
				$obj3->initOrderTemplates();
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj4 = $temp_obj1->getBranch(); // CHECKME
				if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
					$newObject = false;
					$temp_obj4->addOrderTemplate($obj1); // CHECKME
					break;
				}
			}
			
			if ($newObject) {
				$obj4->initOrderTemplates();
	...
	/**
	 * Selects a collection of OrderTemplate objects pre-filled with all related objects except UserByAffiliate.
	 *
	 * @return array Array of OrderTemplate objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinAllExceptUserByAffiliate(Criteria $c, $con = null)
	{
		...
		BranchPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + BranchPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addOrderTemplate($obj1);
					break;
				}
			}
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getBranch(); //CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addOrderTemplate($obj1);
					break;
				}
			}
	...
	{
		return OrderTemplatePeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(OrderTemplatePeer::ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(OrderTemplatePeer::ID, $criteria->remove(OrderTemplatePeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += OrderTemplatePeer::doOnDeleteCascade(new Criteria(), $con);
			$affectedRows += BasePeer::doDeleteAll(OrderTemplatePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof OrderTemplate) {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->begin();
			$affectedRows += OrderTemplatePeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			include_once 'anmaga/OrderTemplateItem.php';

			// delete related OrderTemplateItem objects
			$c = new Criteria();
			
			$c->add(OrderTemplateItemPeer::ORDERTEMPLATEID, $obj->getId());
			$affectedRows += OrderTemplateItemPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
if (Propel::isInit()) {
	...
	try {
		BaseOrderTemplatePeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'anmaga/map/OrderTemplateMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.OrderTemplateMapBuilder');
}
