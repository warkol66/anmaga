...
abstract class BaseOrderTemplatePeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(OrderTemplateMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::BRANCHID);
		$criteria->addSelectColumn(self::TOTAL);
	}
	 ...
	 * @param Connection $con
	 * @return OrderTemplate	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or OrderTemplate object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of OrderTemplate objects pre-filled with their
	...
	/**
	 * Selects a collection of OrderTemplate objects pre-filled with
	 * all related objects.
	 *
	 * @return array Array of OrderTemplate objects.
	 * @throws PropelException Any exceptions caught during processing will be
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		UserByAffiliatePeer::addSelectColumns($c);
		$startcol3 = $startcol2 + UserByAffiliatePeer::$numColumns;
		 
		AffiliatePeer::addSelectColumns($c);
		$startcol4 = $startcol3 + AffiliatePeer::$numColumns;
		 
		BranchPeer::addSelectColumns($c);
		$startcol5 = $startcol4 + BranchPeer::$numColumns;
				$c->addJoin(OrderTemplatePeer::USERID, UserByAffiliatePeer::ID);
	 		$c->addJoin(OrderTemplatePeer::AFFILIATEID, AffiliatePeer::ID);
	 		$c->addJoin(OrderTemplatePeer::BRANCHID, BranchPeer::ID);
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj4 = $temp_obj1->getBranch();
				if ($temp_obj4->getPrimaryKey() === $obj4->getPrimaryKey()) {
					$newObject = false;
					$temp_obj4->addOrderTemplate($obj1);
					break;
				}
			}
	...
	/**
	 * Selects a collection of OrderTemplate objects pre-filled with
	 * all related objects except UserByAffiliate.
	 *
	 * @return array Array of OrderTemplate objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	...
	public static function doSelectJoinAllExceptUserByAffiliate(Criteria $c, $con = null)
	{
		...
		AffiliatePeer::addSelectColumns($c);
		$startcol3 = $startcol2 + AffiliatePeer::$numColumns;
		 
		BranchPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + BranchPeer::$numColumns;
				$c->addJoin(OrderTemplatePeer::AFFILIATEID, AffiliatePeer::ID);
	 		$c->addJoin(OrderTemplatePeer::BRANCHID, BranchPeer::ID);
	...
	/**
	 * Selects a collection of OrderTemplate objects pre-filled with
	 * all related objects except Branch.
	 *
	 * @return array Array of OrderTemplate objects.
	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(OrderTemplateMapBuilder::CLASS_NAME);
}
