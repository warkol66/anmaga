...
// (on-demand) include_once 'anmaga/ModuleDependency.php';
// (on-demand) include_once 'anmaga/ModuleDependencyPeer.php';
 ...
 * extended; all references should be to Module class. 
 * 
 * @package anmaga 
 */
abstract class BaseModule extends BaseObject implements Persistent {
	 ...
	 * @throws PropelException
	 */
	public function setModuleDependencyKey($key)
	{
	 ...
	 */
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aModuleDependency !== null) {
				if ($this->aModuleDependency->isModified()) $this->aModuleDependency->save($con);
	...
	public function validate($columns = null)
	{
	  if ($columns)
	  {
		return ModulePeer::doValidate($this, $columns);
	  }
	...
	protected function doValidate()
	{
		if (! $this->alreadyInValidation) {
			...
			// foreign key reference.
			if ($this->aModuleDependency !== null) {
				if (($retval = $this->aModuleDependency->validate()) !== true) {
					$failureMap = array_merge($failureMap, $retval);
				}
			}

			if (($retval = ModulePeer::doValidate($this)) !== true) {
				$failureMap = array_merge($failureMap, $retval);
			}
