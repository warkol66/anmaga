...
include_once 'anmaga/AffiliateUserPeer.php';
...
abstract class BaseAffiliateUser extends BaseObject  implements Persistent {
	...
	public function getAffiliateUserInfo($con = null)
	{
		...
		include_once 'anmaga/om/BaseAffiliateUserInfoPeer.php';
	...
	{
		// include the related Peer class
		include_once 'anmaga/om/BaseAffiliateLevelPeer.php';
	...
	{
		// include the Peer class
		include_once 'anmaga/om/BaseAffiliateUserGroupPeer.php';
		if ($criteria === null) {
			$criteria = new Criteria();
		}
		elseif ($criteria instanceof Criteria)
