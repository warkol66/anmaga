...
abstract class BaseAffiliateLevelPeer {
	...
	const ID = 'affiliates_level.ID';

	/** the column name for the NAME field */
	const NAME = 'affiliates_level.NAME';

	/** the column name for the BITLEVEL field */
	const BITLEVEL = 'affiliates_level.BITLEVEL';

	/**
	 * An identiy map to hold any loaded instances of AffiliateLevel objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array AffiliateLevel[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. AffiliateLevelPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(AffiliateLevelPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(AffiliateLevelPeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = AffiliateLevelPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return AffiliateLevelPeer::populateObjects(AffiliateLevelPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      AffiliateLevel $value A AffiliateLevel object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(AffiliateLevel $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A AffiliateLevel object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof AffiliateLevel) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or AffiliateLevel object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     AffiliateLevel Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a AffiliateLevel or Criteria object.
	 *
	 * @param      mixed $values Criteria or AffiliateLevel object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from AffiliateLevel object
		}

		if ($criteria->containsKey(AffiliateLevelPeer::ID) && $criteria->keyContainsValue(AffiliateLevelPeer::ID) ) {
	...
	/**
	 * Method perform an UPDATE on the database, given a AffiliateLevel or Criteria object.
	 *
	 * @param      mixed $values Criteria or AffiliateLevel object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the affiliates_level table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a AffiliateLevel or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or AffiliateLevel object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given AffiliateLevel object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      AffiliateLevel $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(AffiliateLevel $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(AffiliateLevelPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(AffiliateLevelPeer::TABLE_NAME);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = AffiliateLevelPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(AffiliateLevelPeer::ID, $pk);

		$v = AffiliateLevelPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(AffiliateLevelPeer::DATABASE_NAME);
			$criteria->add(AffiliateLevelPeer::ID, $pks, Criteria::IN);
			$objs = AffiliateLevelPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
