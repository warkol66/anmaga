...
abstract class BaseAffiliateUserGroup extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'AffiliateUserGroupPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = AffiliateUserGroupPeer::NUM_HYDRATE_COLUMNS.
	...
	{
		$pos = AffiliateUserGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		if (isset($alreadyDumpedObjects['AffiliateUserGroup'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['AffiliateUserGroup'][serialize($this->getPrimaryKey())] = true;
		$keys = AffiliateUserGroupPeer::getFieldNames($keyType);
		$result = array(
	...
	{
		return (string) $this->exportTo(AffiliateUserGroupPeer::DEFAULT_STRING_FORMAT);
	}
