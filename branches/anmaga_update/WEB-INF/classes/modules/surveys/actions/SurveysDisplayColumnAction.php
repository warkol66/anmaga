...
class SurveysDisplayColumnAction extends BaseAction {

	function SurveysDisplayColumnAction() {
		;
	}
...
//		$graph->subtitle->Set($survey->getName());
		...
		$graph->yaxis->SetTickLabels($datax);
		$graph->yaxis->SetFont(FF_VERDANA,FS_NORMAL,8);
		$graph->yaxis->HideTicks(true,true);

		// Some extra margin looks nicer
		$graph->yaxis->SetLabelMargin($xSetLabelMargin);
