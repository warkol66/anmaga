...
/**
 * Base static class for performing query and update operations on the 'surveys_question' table.
 *
 * Pregunta a Encuesta
 *
...
abstract class BaseSurveyQuestionPeer {
	...
	const CLASS_DEFAULT = 'surveys.classes.SurveyQuestion';
	...
	/** the column name for the SURVEYID field */
	const SURVEYID = 'surveys_question.SURVEYID';

	/** the column name for the QUESTION field */
	const QUESTION = 'surveys_question.QUESTION';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SURVEYID', 'QUESTION', 'MULTIPLEANSWER', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'surveyId', 'question', 'multipleAnswer', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SURVEYID' => 1, 'QUESTION' => 2, 'MULTIPLEANSWER' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'surveyId' => 1, 'question' => 2, 'multipleAnswer' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(SurveyQuestionPeer::ID);
			$criteria->addSelectColumn(SurveyQuestionPeer::SURVEYID);
			$criteria->addSelectColumn(SurveyQuestionPeer::QUESTION);
			$criteria->addSelectColumn(SurveyQuestionPeer::MULTIPLEANSWER);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.SURVEYID');
			$criteria->addSelectColumn($alias . '.QUESTION');
			$criteria->addSelectColumn($alias . '.MULTIPLEANSWER');
		}
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to surveys_question
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// Invalidate objects in SurveyAnswerOptionPeer instance pool, 
	...
	/**
	 * Selects a collection of SurveyQuestion objects pre-filled with their Survey objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of SurveyQuestion objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinSurvey(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = SurveyQuestionPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = SurveyQuestionPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://www.propelorm.org/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				SurveyQuestionPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SurveyQuestion) to $obj2 (Survey)
				$obj2->addSurveyQuestion($obj1);
	...
	/**
	 * Selects a collection of SurveyQuestion objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (SurveyQuestion) to the collection in $obj2 (Survey)
				$obj2->addSurveyQuestion($obj1);
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(SurveyQuestionPeer::ID) && $criteria->keyContainsValue(SurveyQuestionPeer::ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SurveyQuestionPeer::ID);
			$value = $criteria->remove(SurveyQuestionPeer::ID);
			if ($value) {
				$selectCriteria->add(SurveyQuestionPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the surveys_question table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SurveyQuestionPeer::doOnDeleteCascade(new Criteria(SurveyQuestionPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SurveyQuestionPeer::ID, (array) $values, Criteria::IN);
		}
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += SurveyQuestionPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = SurveyQuestionPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related SurveyAnswerOption objects
			$criteria = new Criteria(SurveyAnswerOptionPeer::DATABASE_NAME);
			
			$criteria->add(SurveyAnswerOptionPeer::QUESTIONID, $obj->getId());
			$affectedRows += SurveyAnswerOptionPeer::doDelete($criteria, $con);

			// delete related SurveyAnswer objects
			$criteria = new Criteria(SurveyAnswerPeer::DATABASE_NAME);
			
			$criteria->add(SurveyAnswerPeer::QUESTIONID, $obj->getId());
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SurveyQuestionPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SurveyQuestionPeer::DATABASE_NAME);
			$criteria->add(SurveyQuestionPeer::ID, $pks, Criteria::IN);
