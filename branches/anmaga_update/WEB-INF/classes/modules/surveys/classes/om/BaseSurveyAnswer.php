...
abstract class BaseSurveyAnswer extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = SurveyAnswerPeer::NUM_COLUMNS - SurveyAnswerPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			...
			if (null !== $this->aSurveyAnswerOption) {
				$result['SurveyAnswerOption'] = $this->aSurveyAnswerOption->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAnsweroptionid($this->answeroptionid);
