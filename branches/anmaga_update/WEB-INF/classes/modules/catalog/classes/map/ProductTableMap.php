...
class ProductTableMap extends TableMap {
    ...
    $this->addRelation('OrderItem', 'OrderItem', RelationMap::ONE_TO_MANY, array('id' => 'productId', ), null, null);
    $this->addRelation('OrderTemplateItem', 'OrderTemplateItem', RelationMap::ONE_TO_MANY, array('id' => 'productId', ), null, null);
	} // buildRelations()
