 ...
 */
class MeasureUnitTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'catalog.classes.map.MeasureUnitTableMap';
	...
	{
    $this->addRelation('Product', 'Product', RelationMap::ONE_TO_MANY, array('id' => 'measureUnitId', ), null, null);
	} // buildRelations()
