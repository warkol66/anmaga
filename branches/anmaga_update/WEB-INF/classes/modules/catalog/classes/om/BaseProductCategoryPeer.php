...
abstract class BaseProductCategoryPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DESCRIPTION', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DESCRIPTION' => 1, ),
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ProductCategoryPeer::ID) && $criteria->keyContainsValue(ProductCategoryPeer::ID) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ProductCategoryPeer::ID);
			if ($value) {
				$selectCriteria->add(ProductCategoryPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the productCategory table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
