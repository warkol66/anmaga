...
abstract class BaseNode extends BaseObject  implements Persistent
{
	...
	/**
	 * @var        array Node[] Collection to store aggregation of Node objects.
	 */
	...
	public function ensureConsistency()
	{
		...
		if ($this->aNodeRelatedByParentid !== null && $this->parentid !== $this->aNodeRelatedByParentid->getId()) {
			$this->aNodeRelatedByParentid = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aNodeRelatedByParentid !== null) {
				if ($this->aNodeRelatedByParentid->isModified() || $this->aNodeRelatedByParentid->isNew()) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(NodePeer::ID) ) {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $includeForeignObjects = false)
	{
		...
		if ($includeForeignObjects) {
			if (null !== $this->aNodeRelatedByParentid) {
				$result['NodeRelatedByParentid'] = $this->aNodeRelatedByParentid->toArray($keyType, $includeLazyLoadColumns, true);
			}
		}
		return $result;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setNodeRelatedByParentid(Node $v = null)
	{
		if ($v === null) {
	 ...
	 * @throws     PropelException
	 */
	public function getNodeRelatedByParentid(PropelPDO $con = null)
	{
		if ($this->aNodeRelatedByParentid === null && ($this->parentid !== null)) {
			$this->aNodeRelatedByParentid = NodeQuery::create()->findPk($this->parentid, $con);
			/* The following can be used additionally to
				 guarantee the related object contains a reference
				 to this object.  This level of coupling may, however, be
				 undesirable since it could result in an only partially populated collection
				 in the referenced object.
				 $this->aNodeRelatedByParentid->addNodesRelatedById($this);
			 */
		}
	 ...
	 * @return     void
	 */
	public function initNodesRelatedById()
	{
	 ...
	 * @return     PropelCollection|array Node[] List of Node objects
	 * @throws     PropelException
	 */
	public function getNodesRelatedById($criteria = null, PropelPDO $con = null)
	{
		if(null === $this->collNodesRelatedById || null !== $criteria) {
			if ($this->isNew() && null === $this->collNodesRelatedById) {
				...
				$collNodesRelatedById = NodeQuery::create(null, $criteria)
					->filterByNodeRelatedByParentid($this)
					->find($con);
				if (null !== $criteria) {
	...
	public function addNodeRelatedById(Node $l)
	{
		...
		if (!$this->collNodesRelatedById->contains($l)) { // only add it if the **same** object is not already associated
			$this->collNodesRelatedById[]= $l;
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collNodesRelatedById) {
				foreach ((array) $this->collNodesRelatedById as $o) {
