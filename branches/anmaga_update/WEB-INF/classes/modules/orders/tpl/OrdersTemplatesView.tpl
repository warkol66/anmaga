...
<p>A continuaci�n se muestra la plantilla de pedido: |-$orderTemplate->getName()-|. Las plantillas se pueden utilizar para repetir pedidos pulsando el bot�n "Agregar al carrito".</p>
<div id="div_order">
