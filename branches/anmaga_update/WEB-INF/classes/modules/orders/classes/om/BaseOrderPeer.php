...
/**
 * Base static class for performing query and update operations on the 'orders_order' table.
 *
 * Pedido de Productos
 *
...
abstract class BaseOrderPeer {
	...
	const TABLE_NAME = 'orders_order';

	/** the related Propel class for this table */
	const OM_CLASS = 'Order';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'orders.classes.Order';
	...
	const NUMBER = 'orders_order.NUMBER';

	/** the column name for the CREATED field */
	const CREATED = 'orders_order.CREATED';

	/** the column name for the USERID field */
	const USERID = 'orders_order.USERID';

	/** the column name for the AFFILIATEID field */
	const AFFILIATEID = 'orders_order.AFFILIATEID';

	/** the column name for the BRANCHID field */
	const BRANCHID = 'orders_order.BRANCHID';

	/** the column name for the TOTAL field */
	const TOTAL = 'orders_order.TOTAL';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NUMBER', 'CREATED', 'USERID', 'AFFILIATEID', 'BRANCHID', 'TOTAL', 'STATE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'number', 'created', 'userId', 'affiliateId', 'branchId', 'total', 'state', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NUMBER' => 1, 'CREATED' => 2, 'USERID' => 3, 'AFFILIATEID' => 4, 'BRANCHID' => 5, 'TOTAL' => 6, 'STATE' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'number' => 1, 'created' => 2, 'userId' => 3, 'affiliateId' => 4, 'branchId' => 5, 'total' => 6, 'state' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(OrderPeer::CREATED);
			$criteria->addSelectColumn(OrderPeer::USERID);
			$criteria->addSelectColumn(OrderPeer::AFFILIATEID);
			$criteria->addSelectColumn(OrderPeer::BRANCHID);
			$criteria->addSelectColumn(OrderPeer::TOTAL);
	...
	/**
	 * Method to invalidate the instance pool of all tables related to orders_order
	...
	public static function clearRelatedInstancePool()
	{
		...
		// Invalidate objects in OrderStateChangePeer instance pool, 
		// since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
	...
	public static function doCountJoinBranch(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(OrderPeer::BRANCHID, BranchPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Order objects pre-filled with their AffiliateUser objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAffiliateUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Order) to $obj2 (AffiliateUser)
				$obj2->addOrder($obj1);
	...
	/**
	 * Selects a collection of Order objects pre-filled with their Affiliate objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Order objects.
	...
	public static function doSelectJoinAffiliate(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Order) to $obj2 (Affiliate)
				$obj2->addOrder($obj1);
	...
	/**
	 * Selects a collection of Order objects pre-filled with their Branch objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Order objects.
	...
	public static function doSelectJoinBranch(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Order) to $obj2 (Branch)
				$obj2->addOrder($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Order) to the collection in $obj2 (AffiliateUser)
				$obj2->addOrder($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Order) to the collection in $obj3 (Affiliate)
				$obj3->addOrder($obj1);
			} // if joined row not null
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (Order) to the collection in $obj4 (Branch)
				$obj4->addOrder($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Order objects pre-filled with all related objects except AffiliateUser.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAllExceptAffiliateUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = OrderPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Order) to the collection in $obj2 (Affiliate)
				$obj2->addOrder($obj1);
				...
				// Add the $obj1 (Order) to the collection in $obj3 (Branch)
				$obj3->addOrder($obj1);
	...
	/**
	 * Selects a collection of Order objects pre-filled with all related objects except Affiliate.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Selects a collection of Order objects pre-filled with all related objects except Branch.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	/**
	 * Method to DELETE all rows from the orders_order table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(OrderItemPeer::ORDERID, $obj->getId());
			$affectedRows += OrderItemPeer::doDelete($criteria, $con);

			// delete related OrderStateChange objects
			$criteria = new Criteria(OrderStateChangePeer::DATABASE_NAME);
			
			$criteria->add(OrderStateChangePeer::ORDERID, $obj->getId());
			$affectedRows += OrderStateChangePeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
