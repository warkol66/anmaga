 ...
 * @method     UserInfoQuery orderByMailaddress($order = Criteria::ASC) Order by the mailAddress column
 *
 ...
 * @method     UserInfoQuery groupByMailaddress() Group by the mailAddress column
 *
 ...
 * @method     UserInfo findOneByMailaddress(string $mailAddress) Return the first UserInfo filtered by the mailAddress column
 *
 ...
 * @method     array findByMailaddress(string $mailAddress) Return UserInfo objects filtered by the mailAddress column
 *
...
abstract class BaseUserInfoQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'anmaga', $modelName = 'UserInfo', $modelAlias = null)
	{
	...
	public function filterByMailaddress($mailaddress = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(UserInfoPeer::MAILADDRESS, $mailaddress, $comparison);
	}
