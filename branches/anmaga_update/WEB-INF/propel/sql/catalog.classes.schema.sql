...
(
	...
	UNIQUE INDEX `catalog_affiliateProduct_U_1` (`productId`, `affiliateId`),
...
(
	...
	PRIMARY KEY (`id`),
	UNIQUE INDEX `catalog_affiliateProductCode_U_1` (`affiliateId`, `productCodeAffiliate`),
...
(
	...
	`stockAlert` INTEGER COMMENT 'Stock alert',
	`stock01` INTEGER COMMENT 'Stock 01',
	`stock02` INTEGER COMMENT 'Stock 02',
	`stock03` INTEGER COMMENT 'Stock 03',
	PRIMARY KEY (`id`),
	UNIQUE INDEX `catalog_product_U_1` (`code`),
