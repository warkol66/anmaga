 ...
 * @method     AffiliateInfo findOneByAffiliateinternalnumber(int $affiliateInternalNumber) Return the first AffiliateInfo filtered by the affiliateInternalNumber column
 ...
 * @method     array findByAffiliateinternalnumber(int $affiliateInternalNumber) Return AffiliateInfo objects filtered by the affiliateInternalNumber column
...
abstract class BaseAffiliateInfoQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'application', $modelName = 'AffiliateInfo', $modelAlias = null)
	{
	 ...
	 * 
	 * @param     int|array $affiliateinternalnumber The value to use as filter.
	 *            Accepts an associative array('min' => $minValue, 'max' => $maxValue)
	 * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
	 *
	 * @return    AffiliateInfoQuery The current query, for fluid interface
	...
	public function filterByAffiliateinternalnumber($affiliateinternalnumber = null, $comparison = null)
	{
		if (is_array($affiliateinternalnumber)) {
			$useMinMax = false;
			if (isset($affiliateinternalnumber['min'])) {
				$this->addUsingAlias(AffiliateInfoPeer::AFFILIATEINTERNALNUMBER, $affiliateinternalnumber['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($affiliateinternalnumber['max'])) {
				$this->addUsingAlias(AffiliateInfoPeer::AFFILIATEINTERNALNUMBER, $affiliateinternalnumber['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
