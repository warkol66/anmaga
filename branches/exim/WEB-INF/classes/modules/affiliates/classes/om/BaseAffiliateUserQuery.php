 ...
 *
 * @method     AffiliateUserQuery leftJoinClientQuote($relationAlias = null) Adds a LEFT JOIN clause to the query using the ClientQuote relation
 * @method     AffiliateUserQuery rightJoinClientQuote($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ClientQuote relation
 * @method     AffiliateUserQuery innerJoinClientQuote($relationAlias = null) Adds a INNER JOIN clause to the query using the ClientQuote relation
 *
 * @method     AffiliateUserQuery leftJoinClientPurchaseOrder($relationAlias = null) Adds a LEFT JOIN clause to the query using the ClientPurchaseOrder relation
 * @method     AffiliateUserQuery rightJoinClientPurchaseOrder($relationAlias = null) Adds a RIGHT JOIN clause to the query using the ClientPurchaseOrder relation
 * @method     AffiliateUserQuery innerJoinClientPurchaseOrder($relationAlias = null) Adds a INNER JOIN clause to the query using the ClientPurchaseOrder relation
 *
 * @method     AffiliateUserQuery leftJoinSupplierPurchaseOrder($relationAlias = null) Adds a LEFT JOIN clause to the query using the SupplierPurchaseOrder relation
 * @method     AffiliateUserQuery rightJoinSupplierPurchaseOrder($relationAlias = null) Adds a RIGHT JOIN clause to the query using the SupplierPurchaseOrder relation
 * @method     AffiliateUserQuery innerJoinSupplierPurchaseOrder($relationAlias = null) Adds a INNER JOIN clause to the query using the SupplierPurchaseOrder relation
 *
...
abstract class BaseAffiliateUserQuery extends ModelCriteria
{
	...
	{
		return $this
			->addUsingAlias(AffiliateUserPeer::ID, $clientQuote->getAffiliateuserid(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(AffiliateUserPeer::ID, $clientPurchaseOrder->getAffiliateuserid(), $comparison);
	}
	...
	{
		return $this
			->addUsingAlias(AffiliateUserPeer::ID, $supplierPurchaseOrder->getAffiliateuserid(), $comparison);
	}
