...
abstract class BaseAffiliatePeer {
	...
	{
		// Invalidate objects in AffiliateInfoPeer instance pool, 
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = AffiliatePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + AffiliatePeer::NUM_COLUMNS;
		} else {
			$cls = AffiliatePeer::OM_CLASS;
			$obj = new $cls();
	...
	{
		return $withPrefix ? AffiliatePeer::CLASS_DEFAULT : AffiliatePeer::OM_CLASS;
	}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related AffiliateInfo objects
			$criteria = new Criteria(AffiliateInfoPeer::DATABASE_NAME);
			
			$criteria->add(AffiliateInfoPeer::AFFILIATEID, $obj->getId());
			$affectedRows += AffiliateInfoPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
