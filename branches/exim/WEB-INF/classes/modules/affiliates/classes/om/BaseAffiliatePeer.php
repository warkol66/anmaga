...
abstract class BaseAffiliatePeer {
	...
	const CLASS_DEFAULT = 'affiliates.classes.Affiliate';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new AffiliateMapBuilder();
		}
	 ...
	 *
	 * @param      Affiliate $value A Affiliate object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Affiliate $obj, $key = null)
	{
	...
	{
		return AffiliatePeer::CLASS_DEFAULT;
	}

	/**
	 * Method perform an INSERT on the database, given a Affiliate or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Affiliate or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(AffiliatePeer::ID, $criteria->remove(AffiliatePeer::ID), $comparison);
	...
	/**
	 * Method to DELETE all rows from the affiliates_affiliate table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(AffiliatePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Affiliate or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Affiliate $obj, $cols = null)
	{
		$columns = array();
...
//
// NOTE: This static code cannot call methods on the AffiliatePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the AffiliatePeer class:
//
// Propel::getDatabaseMap(AffiliatePeer::DATABASE_NAME)->addTableBuilder(AffiliatePeer::TABLE_NAME, AffiliatePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseAffiliatePeer::DATABASE_NAME)->addTableBuilder(BaseAffiliatePeer::TABLE_NAME, BaseAffiliatePeer::getMapBuilder());
