...
/**
 * Base class that represents a row from the 'import_supplierQuoteHistory' table.
 *
 * Historial de Cotizacion a Proveedor
 *
 * @package    propel.generator.import.classes.om
 */
abstract class BaseSupplierQuoteHistory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'SupplierQuoteHistoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        SupplierQuoteHistoryPeer
	 */
	 ...
	 * Id de la cotizacion de proveedor
	 * @return     int
	 */
	 ...
	 * @return     SupplierQuoteHistory The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SupplierQuoteHistoryPeer::ID;
		}
	...
	public function setSupplierquoteid($v)
	{
		...
		if ($this->supplierquoteid !== $v) {
			...
			$this->modifiedColumns[] = SupplierQuoteHistoryPeer::SUPPLIERQUOTEID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = SupplierQuoteHistoryPeer::STATUS;
		}
	...
	public function setCreatedat($v)
	{
		...
		if ( $this->createdat !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SupplierQuoteHistoryPeer::CREATEDAT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = SupplierQuoteHistoryPeer::NUM_COLUMNS - SupplierQuoteHistoryPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SupplierQuoteHistory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SupplierQuoteHistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				SupplierQuoteHistoryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				SupplierQuoteHistoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(SupplierQuoteHistoryPeer::ID) ) {
					...
					$affectedRows += SupplierQuoteHistoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SupplierQuoteHistoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SupplierQuoteHistoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SupplierQuoteHistoryPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SupplierQuoteHistoryPeer::ID)) $criteria->add(SupplierQuoteHistoryPeer::ID, $this->id);
		if ($this->isColumnModified(SupplierQuoteHistoryPeer::SUPPLIERQUOTEID)) $criteria->add(SupplierQuoteHistoryPeer::SUPPLIERQUOTEID, $this->supplierquoteid);
		if ($this->isColumnModified(SupplierQuoteHistoryPeer::STATUS)) $criteria->add(SupplierQuoteHistoryPeer::STATUS, $this->status);
		if ($this->isColumnModified(SupplierQuoteHistoryPeer::CREATEDAT)) $criteria->add(SupplierQuoteHistoryPeer::CREATEDAT, $this->createdat);
	...
	{
		$criteria = new Criteria(SupplierQuoteHistoryPeer::DATABASE_NAME);
		$criteria->add(SupplierQuoteHistoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SupplierQuoteHistory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SupplierQuoteHistory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SupplierQuoteHistoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SupplierQuoteHistoryPeer();
		}
		return self::$peer;
	}
	...
	public function setSupplierQuote(SupplierQuote $v = null)
	{
		...
		if ($v !== null) {
			$v->addSupplierQuoteHistory($this);
		}
	...
	public function getSupplierQuote(PropelPDO $con = null)
	{
		if ($this->aSupplierQuote === null && ($this->supplierquoteid !== null)) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aSupplierQuote->addSupplierQuoteHistorys($this);
			 */
		}
