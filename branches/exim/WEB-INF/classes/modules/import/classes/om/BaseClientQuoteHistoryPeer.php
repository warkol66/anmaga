...
abstract class BaseClientQuoteHistoryPeer {
	...
	const ID = 'import_clientQuoteHistory.ID';

	/** the column name for the CLIENTQUOTEID field */
	const CLIENTQUOTEID = 'import_clientQuoteHistory.CLIENTQUOTEID';

	/** the column name for the STATUS field */
	const STATUS = 'import_clientQuoteHistory.STATUS';

	/** the column name for the CREATEDAT field */
	const CREATEDAT = 'import_clientQuoteHistory.CREATEDAT';

	/**
	 * An identiy map to hold any loaded instances of ClientQuoteHistory objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ClientQuoteHistory[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. ClientQuoteHistoryPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(ClientQuoteHistoryPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ClientQuoteHistoryPeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ClientQuoteHistoryPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ClientQuoteHistoryPeer::populateObjects(ClientQuoteHistoryPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      ClientQuoteHistory $value A ClientQuoteHistory object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ClientQuoteHistory $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A ClientQuoteHistory object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ClientQuoteHistory) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ClientQuoteHistory object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     ClientQuoteHistory Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinClientQuote(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ClientQuoteHistory) to $obj2 (ClientQuote)
				$obj2->addClientQuoteHistory($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ClientQuoteHistory) to the collection in $obj2 (ClientQuote)
				$obj2->addClientQuoteHistory($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a ClientQuoteHistory or Criteria object.
	 *
	 * @param      mixed $values Criteria or ClientQuoteHistory object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(ClientQuoteHistoryPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from ClientQuoteHistory object
		}

		if ($criteria->containsKey(ClientQuoteHistoryPeer::ID) && $criteria->keyContainsValue(ClientQuoteHistoryPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ClientQuoteHistoryPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ClientQuoteHistory or Criteria object.
	 *
	 * @param      mixed $values Criteria or ClientQuoteHistory object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the import_clientQuoteHistory table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ClientQuoteHistory or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ClientQuoteHistory object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given ClientQuoteHistory object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ClientQuoteHistory $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(ClientQuoteHistory $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ClientQuoteHistoryPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ClientQuoteHistoryPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(ClientQuoteHistoryPeer::DATABASE_NAME, ClientQuoteHistoryPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ClientQuoteHistoryPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria = new Criteria(ClientQuoteHistoryPeer::DATABASE_NAME);
		$criteria->add(ClientQuoteHistoryPeer::ID, $pk);

		$v = ClientQuoteHistoryPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ClientQuoteHistoryPeer::DATABASE_NAME);
			$criteria->add(ClientQuoteHistoryPeer::ID, $pks, Criteria::IN);
			$objs = ClientQuoteHistoryPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
