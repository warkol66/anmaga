...
abstract class BaseIncotermPeer {
	...
	const ID = 'import_incoterm.ID';

	/** the column name for the NAME field */
	const NAME = 'import_incoterm.NAME';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'import_incoterm.DESCRIPTION';

	/** the column name for the ACTIVE field */
	const ACTIVE = 'import_incoterm.ACTIVE';

	/**
	 * An identiy map to hold any loaded instances of Incoterm objects.
	 ...
	 * @param      string $column The column name for current table. (i.e. IncotermPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(IncotermPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(IncotermPeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = IncotermPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return IncotermPeer::populateObjects(IncotermPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      Incoterm $value A Incoterm object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Incoterm $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A Incoterm object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Incoterm) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Incoterm object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     Incoterm Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a Incoterm or Criteria object.
	 *
	 * @param      mixed $values Criteria or Incoterm object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from Incoterm object
		}

		if ($criteria->containsKey(IncotermPeer::ID) && $criteria->keyContainsValue(IncotermPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.IncotermPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Incoterm or Criteria object.
	 *
	 * @param      mixed $values Criteria or Incoterm object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the import_incoterm table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Incoterm or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or Incoterm object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given Incoterm object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      Incoterm $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(Incoterm $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(IncotermPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(IncotermPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(IncotermPeer::DATABASE_NAME, IncotermPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = IncotermPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(IncotermPeer::ID, $pk);

		$v = IncotermPeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(IncotermPeer::DATABASE_NAME);
			$criteria->add(IncotermPeer::ID, $pks, Criteria::IN);
			$objs = IncotermPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
