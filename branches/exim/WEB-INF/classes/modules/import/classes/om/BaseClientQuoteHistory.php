...
/**
 * Base class that represents a row from the 'import_clientQuoteHistory' table.
 *
 * Historial de Cotizacion a Cliente
 *
 * @package    propel.generator.import.classes.om
 */
abstract class BaseClientQuoteHistory extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
  const PEER = 'ClientQuoteHistoryPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ClientQuoteHistoryPeer
	 */
	 ...
	 * Id de la cotizacion de cliente
	 * @return     int
	 */
	 ...
	 * @return     ClientQuoteHistory The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ClientQuoteHistoryPeer::ID;
		}
	...
	public function setClientquoteid($v)
	{
		...
		if ($this->clientquoteid !== $v) {
			...
			$this->modifiedColumns[] = ClientQuoteHistoryPeer::CLIENTQUOTEID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = ClientQuoteHistoryPeer::STATUS;
		}
	...
	public function setCreatedat($v)
	{
		...
		if ( $this->createdat !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ClientQuoteHistoryPeer::CREATEDAT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ClientQuoteHistoryPeer::NUM_COLUMNS - ClientQuoteHistoryPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ClientQuoteHistory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ClientQuoteHistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				ClientQuoteHistoryQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ClientQuoteHistoryPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(ClientQuoteHistoryPeer::ID) ) {
					...
					$affectedRows += ClientQuoteHistoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ClientQuoteHistoryPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ClientQuoteHistoryPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = ClientQuoteHistoryPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getClientquoteid(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setClientquoteid($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientQuoteHistoryPeer::ID)) $criteria->add(ClientQuoteHistoryPeer::ID, $this->id);
		if ($this->isColumnModified(ClientQuoteHistoryPeer::CLIENTQUOTEID)) $criteria->add(ClientQuoteHistoryPeer::CLIENTQUOTEID, $this->clientquoteid);
		if ($this->isColumnModified(ClientQuoteHistoryPeer::STATUS)) $criteria->add(ClientQuoteHistoryPeer::STATUS, $this->status);
		if ($this->isColumnModified(ClientQuoteHistoryPeer::CREATEDAT)) $criteria->add(ClientQuoteHistoryPeer::CREATEDAT, $this->createdat);
	...
	{
		$criteria = new Criteria(ClientQuoteHistoryPeer::DATABASE_NAME);
		$criteria->add(ClientQuoteHistoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ClientQuoteHistory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ClientQuoteHistory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ClientQuoteHistoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ClientQuoteHistoryPeer();
		}
		return self::$peer;
	}
	...
	public function getClientQuote(PropelPDO $con = null)
	{
		if ($this->aClientQuote === null && ($this->clientquoteid !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aClientQuote->addClientQuoteHistorys($this);
			 */
		}
