...
abstract class BaseClientPurchaseOrderHistoryPeer {
	...
	const OM_CLASS = 'ClientPurchaseOrderHistory';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'import.classes.ClientPurchaseOrderHistory';

	/** the related TableMap class for this table */
	const TM_CLASS = 'ClientPurchaseOrderHistoryTableMap';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CLIENTPURCHASEORDERID', 'STATUS', 'CREATEDAT', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CLIENTPURCHASEORDERID' => 1, 'STATUS' => 2, 'CREATEDAT' => 3, ),
	...
	/**
	 * Method to invalidate the instance pool of all tables related to import_clientPurchaseOrderHistory
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = ClientPurchaseOrderHistoryPeer::getOMClass(false);
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (ClientPurchaseOrderHistory object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = ClientPurchaseOrderHistoryPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = ClientPurchaseOrderHistoryPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + ClientPurchaseOrderHistoryPeer::NUM_COLUMNS;
		} else {
			$cls = ClientPurchaseOrderHistoryPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doCountJoinClientPurchaseOrder(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ClientPurchaseOrderHistoryPeer::CLIENTPURCHASEORDERID, ClientPurchaseOrderPeer::ID, $join_behavior);
	...
	{
	  $dbMap = Propel::getDatabaseMap(BaseClientPurchaseOrderHistoryPeer::DATABASE_NAME);
	  if (!$dbMap->hasTable(BaseClientPurchaseOrderHistoryPeer::TABLE_NAME))
	  {
	    $dbMap->addTableObject(new ClientPurchaseOrderHistoryTableMap());
	  }
	}
	...
	{
		return $withPrefix ? ClientPurchaseOrderHistoryPeer::CLASS_DEFAULT : ClientPurchaseOrderHistoryPeer::OM_CLASS;
	}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(ClientPurchaseOrderHistoryPeer::ID);
			if ($value) {
				$selectCriteria->add(ClientPurchaseOrderHistoryPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ClientPurchaseOrderHistoryPeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(ClientPurchaseOrderHistoryPeer::TABLE_NAME, $con, ClientPurchaseOrderHistoryPeer::DATABASE_NAME);
			// Because this db requires some delete cascade/set null emulation, we have to
			// clear the cached instance *after* the emulation has happened (since
			// instances get re-added by the select statement contained therein).
			ClientPurchaseOrderHistoryPeer::clearInstancePool();
			ClientPurchaseOrderHistoryPeer::clearRelatedInstancePool();
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof ClientPurchaseOrderHistory) { // it's a model object
...
//
BaseClientPurchaseOrderHistoryPeer::buildTableMap();
