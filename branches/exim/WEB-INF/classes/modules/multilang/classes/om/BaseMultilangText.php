...
abstract class BaseMultilangText extends BaseObject  implements Persistent
{
	...
	{
		$pos = MultilangTextPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setLanguagecode($arr[$keys[2]]);
	...
	{
		return (null === $this->getId()) && (null === $this->getModulename()) && (null === $this->getLanguagecode());
	}
	...
	public function getMultilangLanguage(PropelPDO $con = null)
	{
		if ($this->aMultilangLanguage === null && (($this->languagecode !== "" && $this->languagecode !== null))) {
			$this->aMultilangLanguage = MultilangLanguageQuery::create()
