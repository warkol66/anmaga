...
abstract class BaseModulePeer {
	...
	const NAME = 'modules_module.NAME';

	/** the column name for the ACTIVE field */
	const ACTIVE = 'modules_module.ACTIVE';
	...
	/**
	 * Method to DELETE all rows from the modules_module table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ModulePeer::NAME, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ModulePeer::DATABASE_NAME);
			$criteria->add(ModulePeer::NAME, $pks, Criteria::IN);
