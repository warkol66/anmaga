...
(
	...
	`status` INTEGER  NOT NULL COMMENT 'Status de Embarque',
	`containersRealCount20` INTEGER   COMMENT 'Cantidad real de containers de 20\'',
	`containersRealCount40` INTEGER   COMMENT 'Cantidad real de containers de 40\'',
...
(
	...
	`status` INTEGER  NOT NULL COMMENT 'Status de Nacionalizacion',
