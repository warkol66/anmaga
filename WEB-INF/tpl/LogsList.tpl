	...
	<td>
		...
		|-if $DISPLAY eq 1-| 
			<table width="100%"  border="0" cellpadding="5" cellspacing="0">
				<tr> 
					<td class="size2">Consultar hist&oacute;rico de operaciones del Sistema 
					</td>
				</tr>
				<tr class="row_even"> 
				...
				|-/if-|
				<tr> 
					<td align="center"><input name="saveButton" type="submit" class="boton" id="saveButton" value="Listar"></td>
				</tr>
			 </table>
			</form>
		</td>
	...
	<td class="nopaddingCell"> 
		<table width="100%"  border="0" cellpadding="4" cellspacing="1" class="size4">
			<tr class="thresultado"> 
				...
				<th width="40%" scope="col"><a href='Main.php?|-$QUERY_STRING_NO_ORDER-|&order=accion' class='thresultado'>Acci&oacute;n</a></th>
				<th width="30%" scope="col"><a href='Main.php?|-$QUERY_STRING_NO_ORDER-|&order=mensaje' class='thresultado'>Mensaje</a></th>
