...
<table width="150" border="0" cellpadding="0" cellspacing="0" class="menuCell">
  <tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=usersWelcome">Ir al Inicio</a></td>
  </tr>
	<tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=catalogShow">Catálogo</a></td>
  </tr>
	<tr> 
    <td class="menuCell"><div class="divmenu2sec"><a class="botones" href="Main.php?do=catalogProductCategoriesList">Administrar Categorías de Productos</a></div>
		<div class="divmenu2sec"><a class="botones" href="Main.php?do=catalogProductsList">Administrar Productos</a></div>
		<div class="divmenu2sec"><a class="botones" href="Main.php?do=catalogUnitsList">Administrar Unidades</a></div>
		<div class="divmenu2sec"><a class="botones" href="Main.php?do=catalogMeasureUnitsList">Administrar Unidades de Medida</a></div>
	</td>
  </tr>
	<tr> 
	...
	<tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=configEdit">Editar Configuración</a></td>
  </tr>
	<tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=usersList">Editar Usuarios</a></td>
  </tr>
	<tr> 
...
<table width="150" border="0" cellpadding="0" cellspacing="0" class="menuCell">
  <tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=usersByaffiliateWelcome">Ir al Inicio</a></td>
  </tr>
	<tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=catalogShow">Catálogo</a></td>
  </tr>
