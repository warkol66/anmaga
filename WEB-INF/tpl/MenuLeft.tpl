<table width="150" border="0" cellpadding="0" cellspacing="0" class="menuCell">
  <tr> 
	...
	<tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=catalogProductCategoriesList">Administrar Categorías de Productos</a></td>
  </tr>
	<tr> 
    <td class="menuCell"><a class="botones" href="Main.php?do=catalogProductsList">Administrar Productos</a></td>
  </tr>
	<tr> 
