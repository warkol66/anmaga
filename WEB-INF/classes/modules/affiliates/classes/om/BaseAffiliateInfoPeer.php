...
abstract class BaseAffiliateInfoPeer {
	...
	/**
	 * An identiy map to hold any loaded instances of AffiliateInfo objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array AffiliateInfo[]
	 */
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(AffiliateInfoPeer::TABLE_NAME);
	...
	{
		return AffiliateInfoPeer::populateObjects(AffiliateInfoPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      AffiliateInfo $value A AffiliateInfo object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(AffiliateInfo $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getAffiliateid();
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A AffiliateInfo object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof AffiliateInfo) {
				$key = (string) $value->getAffiliateid();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or AffiliateInfo object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     AffiliateInfo Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doCountJoinAffiliate(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AffiliateInfoPeer::AFFILIATEID, AffiliatePeer::ID, $join_behavior);
	...
	public static function doSelectJoinAffiliate(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		AffiliateInfoPeer::addSelectColumns($criteria);
		$startcol = (AffiliateInfoPeer::NUM_COLUMNS - AffiliateInfoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = AffiliateInfoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = AffiliateInfoPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://www.propelorm.org/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				AffiliateInfoPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AffiliateInfo) to $obj2 (Affiliate)
				// one to one relationship
				$obj1->setAffiliate($obj2);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		AffiliateInfoPeer::addSelectColumns($criteria);
		$startcol2 = (AffiliateInfoPeer::NUM_COLUMNS - AffiliateInfoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (AffiliateInfo) to the collection in $obj2 (Affiliate)
				$obj1->setAffiliate($obj2);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = AffiliateInfoPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
