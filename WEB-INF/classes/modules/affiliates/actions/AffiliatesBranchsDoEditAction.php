	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		if ( $_POST["action"] == "edit" ) {
			...
			if ( BranchPeer::update($_POST["id"],$_POST["affiliateId"],$_POST["number"],$_POST["name"],$_POST["phone"],$_POST["contact"],$_POST["contactEmail"],$_POST["memo"]) )
      ...
      if ( !BranchPeer::create($_POST["affiliateId"],$_POST["number"],$_POST["name"],$_POST["phone"],$_POST["contact"],$_POST["contactEmail"],$_POST["memo"]) ) {
