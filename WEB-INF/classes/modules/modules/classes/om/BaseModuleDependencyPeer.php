...
abstract class BaseModuleDependencyPeer {
	...
	const DEPENDENCE = 'modules_dependency.DEPENDENCE';

	/**
	 * An identiy map to hold any loaded instances of ModuleDependency objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ModuleDependency[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. ModuleDependencyPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(ModuleDependencyPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ModuleDependencyPeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ModuleDependencyPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ModuleDependencyPeer::populateObjects(ModuleDependencyPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      ModuleDependency $value A ModuleDependency object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ModuleDependency $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getModulename(), (string) $obj->getDependence()));
			} // if key === null
	 ...
	 *
	 * @param      mixed $value A ModuleDependency object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ModuleDependency) {
				$key = serialize(array((string) $value->getModulename(), (string) $value->getDependence()));
			} elseif (is_array($value) && count($value) === 2) {
				// assume we've been passed a primary key
				$key = serialize(array((string) $value[0], (string) $value[1]));
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ModuleDependency object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     ModuleDependency Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinModule(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ModuleDependency) to $obj2 (Module)
				$obj2->addModuleDependency($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ModuleDependency) to the collection in $obj2 (Module)
				$obj2->addModuleDependency($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a ModuleDependency or Criteria object.
	 *
	 * @param      mixed $values Criteria or ModuleDependency object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(ModuleDependencyPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from ModuleDependency object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a ModuleDependency or Criteria object.
	 *
	 * @param      mixed $values Criteria or ModuleDependency object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the modules_dependency table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ModuleDependency or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ModuleDependency object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given ModuleDependency object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ModuleDependency $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(ModuleDependency $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ModuleDependencyPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ModuleDependencyPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(ModuleDependencyPeer::DATABASE_NAME, ModuleDependencyPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($modulename, $dependence, PropelPDO $con = null) {
		...
		$criteria->add(ModuleDependencyPeer::MODULENAME, $modulename);
		$criteria->add(ModuleDependencyPeer::DEPENDENCE, $dependence);
		$v = ModuleDependencyPeer::doSelect($criteria, $con);
