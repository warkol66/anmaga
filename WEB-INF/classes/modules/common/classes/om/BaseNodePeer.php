...
abstract class BaseNodePeer {
	...
	const CLASS_DEFAULT = 'common.classes.Node';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Kind', 'Objectid', 'Parentid', 'Position', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'kind', 'objectid', 'parentid', 'position', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::KIND, self::OBJECTID, self::PARENTID, self::POSITION, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'KIND', 'OBJECTID', 'PARENTID', 'POSITION', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'kind', 'objectId', 'parentId', 'position', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Kind' => 2, 'Objectid' => 3, 'Parentid' => 4, 'Position' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'kind' => 2, 'objectid' => 3, 'parentid' => 4, 'position' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::KIND => 2, self::OBJECTID => 3, self::PARENTID => 4, self::POSITION => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'KIND' => 2, 'OBJECTID' => 3, 'PARENTID' => 4, 'POSITION' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'kind' => 2, 'objectId' => 3, 'parentId' => 4, 'position' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(NodePeer::NAME);
			$criteria->addSelectColumn(NodePeer::KIND);
			$criteria->addSelectColumn(NodePeer::OBJECTID);
			$criteria->addSelectColumn(NodePeer::PARENTID);
			$criteria->addSelectColumn(NodePeer::POSITION);
		} else {
	 ...
	 *
	 * @param      Node $value A Node object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Node $obj, $key = null)
	{
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = NodePeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + NodePeer::NUM_COLUMNS;
		} else {
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		NodePeer::addSelectColumns($criteria);
		$startcol2 = (NodePeer::NUM_COLUMNS - NodePeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? NodePeer::CLASS_DEFAULT : NodePeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Node or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a Node or Criteria object.
	 *
	...
	/**
	 * Method perform a DELETE on the database, given a Node or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Node $obj, $cols = null)
	{
		$columns = array();
