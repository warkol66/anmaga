...
/**
 * Base class that represents a row from the 'multilang_language' table.
 *
 * 
 *
 * @package    propel.generator.multilang.classes.om
 */
abstract class BaseMultilangLanguage extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
  const PEER = 'MultilangLanguagePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        MultilangLanguagePeer
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = MultilangLanguagePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = MultilangLanguagePeer::NAME;
		}
	...
	public function setCode($v)
	{
		...
		if ($this->code !== $v) {
			$this->code = $v;
			$this->modifiedColumns[] = MultilangLanguagePeer::CODE;
		}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = MultilangLanguagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(MultilangLanguagePeer::ID) ) {
					...
					$affectedRows = MultilangLanguagePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = MultilangLanguagePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = MultilangLanguagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = MultilangLanguagePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getCode(),
	...
	{
		$criteria = new Criteria(MultilangLanguagePeer::DATABASE_NAME);
		$criteria->add(MultilangLanguagePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of MultilangLanguage (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     MultilangLanguage Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     MultilangLanguagePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new MultilangLanguagePeer();
		}
		return self::$peer;
	}
	 ...
	 * If this MultilangLanguage is new, it will return
		...
		if(null === $this->collMultilangTexts || null !== $criteria) {
			if ($this->isNew() && null === $this->collMultilangTexts) {
				...
				$collMultilangTexts = MultilangTextQuery::create(null, $criteria)
					->filterByMultilangLanguage($this)
					->find($con);
				if (null !== $criteria) {
	 ...
	 * Otherwise if this MultilangLanguage is new, it will return
	 * an empty collection; or if this MultilangLanguage has previously
	 * been saved, it will retrieve related MultilangTexts from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in MultilangLanguage.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	 ...
	 * @return     PropelCollection|array MultilangText[] List of MultilangText objects
	 */
	public function getMultilangTextsJoinModule($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = MultilangTextQuery::create(null, $criteria);
