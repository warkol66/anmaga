...
abstract class BaseClientQuotePeer {
	...
	const ID = 'import_clientQuote.ID';

	/** the column name for the CREATEDAT field */
	const CREATEDAT = 'import_clientQuote.CREATEDAT';

	/** the column name for the AFFILIATEID field */
	const AFFILIATEID = 'import_clientQuote.AFFILIATEID';

	/** the column name for the AFFILIATEUSERID field */
	const AFFILIATEUSERID = 'import_clientQuote.AFFILIATEUSERID';

	/** the column name for the USERID field */
	const USERID = 'import_clientQuote.USERID';

	/** the column name for the STATUS field */
	const STATUS = 'import_clientQuote.STATUS';

	/** the column name for the TIMESTAMPSTATUS field */
	const TIMESTAMPSTATUS = 'import_clientQuote.TIMESTAMPSTATUS';

	/**
	 * An identiy map to hold any loaded instances of ClientQuote objects.
	 * This must be public so that other peer classes can access this when hydrating from JOIN
	 * queries.
	 * @var        array ClientQuote[]
	 */
	 ...
	 * @param      string $column The column name for current table. (i.e. ClientQuotePeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(ClientQuotePeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(ClientQuotePeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = ClientQuotePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return ClientQuotePeer::populateObjects(ClientQuotePeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      ClientQuote $value A ClientQuote object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(ClientQuote $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A ClientQuote object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ClientQuote) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or ClientQuote object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     ClientQuote Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ClientQuote) to $obj2 (User)
				$obj2->addClientQuote($obj1);
	...
	public static function doSelectJoinAffiliate(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ClientQuote) to $obj2 (Affiliate)
				$obj2->addClientQuote($obj1);
	...
	public static function doSelectJoinAffiliateUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ClientQuote) to $obj2 (AffiliateUser)
				$obj2->addClientQuote($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ClientQuote) to the collection in $obj2 (User)
				$obj2->addClientQuote($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (ClientQuote) to the collection in $obj3 (Affiliate)
				$obj3->addClientQuote($obj1);
			} // if joined row not null
			...
			if ($key4 !== null) {
				...
				// Add the $obj1 (ClientQuote) to the collection in $obj4 (AffiliateUser)
				$obj4->addClientQuote($obj1);
			} // if joined row not null
	...
	public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = ClientQuotePeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (ClientQuote) to the collection in $obj2 (Affiliate)
				$obj2->addClientQuote($obj1);
				...
				// Add the $obj1 (ClientQuote) to the collection in $obj3 (AffiliateUser)
				$obj3->addClientQuote($obj1);
	...
	/**
	 * Method perform an INSERT on the database, given a ClientQuote or Criteria object.
	 *
	 * @param      mixed $values Criteria or ClientQuote object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from ClientQuote object
		}

		if ($criteria->containsKey(ClientQuotePeer::ID) && $criteria->keyContainsValue(ClientQuotePeer::ID) ) {
	...
	/**
	 * Method perform an UPDATE on the database, given a ClientQuote or Criteria object.
	 *
	 * @param      mixed $values Criteria or ClientQuote object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the import_clientQuote table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ClientQuote or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or ClientQuote object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given ClientQuote object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      ClientQuote $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(ClientQuote $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(ClientQuotePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(ClientQuotePeer::TABLE_NAME);
		...
		return BasePeer::doValidate(ClientQuotePeer::DATABASE_NAME, ClientQuotePeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ClientQuotePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(ClientQuotePeer::ID, $pk);

		$v = ClientQuotePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ClientQuotePeer::DATABASE_NAME);
			$criteria->add(ClientQuotePeer::ID, $pks, Criteria::IN);
			$objs = ClientQuotePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
