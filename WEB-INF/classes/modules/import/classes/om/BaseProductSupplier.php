...
abstract class BaseProductSupplier extends BaseObject  implements Persistent
{
	 ...
	 * @return     ProductSupplier The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->supplierid = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProductSupplierPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function getSupplier(PropelPDO $con = null)
	{
		if ($this->aSupplier === null && (($this->supplierid !== "" && $this->supplierid !== null))) {
			...
			/* The following can be used additionally to
				 ...
				 $this->aSupplier->addProductSuppliers($this);
			 */
		}
