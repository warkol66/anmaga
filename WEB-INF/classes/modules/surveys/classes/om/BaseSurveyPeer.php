...
/**
 * Base static class for performing query and update operations on the 'surveys_survey' table.
 *
 * Encuestas
 *
...
abstract class BaseSurveyPeer {
	...
	const TABLE_NAME = 'surveys_survey';

	/** the related Propel class for this table */
	const OM_CLASS = 'Survey';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'surveys.classes.Survey';
	...
	const NAME = 'surveys_survey.NAME';

	/** the column name for the ISPUBLIC field */
	const ISPUBLIC = 'surveys_survey.ISPUBLIC';

	/** the column name for the STARTDATE field */
	const STARTDATE = 'surveys_survey.STARTDATE';

	/** the column name for the ENDDATE field */
	const ENDDATE = 'surveys_survey.ENDDATE';

	/** the column name for the DELETED_AT field */
	const DELETED_AT = 'surveys_survey.DELETED_AT';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'surveys_survey.CREATED_AT';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ISPUBLIC', 'STARTDATE', 'ENDDATE', 'DELETED_AT', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'isPublic', 'startDate', 'endDate', 'deleted_at', 'created_at', 'updated_at', ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ISPUBLIC' => 2, 'STARTDATE' => 3, 'ENDDATE' => 4, 'DELETED_AT' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'isPublic' => 2, 'startDate' => 3, 'endDate' => 4, 'deleted_at' => 5, 'created_at' => 6, 'updated_at' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(SurveyPeer::NAME);
			$criteria->addSelectColumn(SurveyPeer::ISPUBLIC);
			$criteria->addSelectColumn(SurveyPeer::STARTDATE);
			$criteria->addSelectColumn(SurveyPeer::ENDDATE);
			$criteria->addSelectColumn(SurveyPeer::DELETED_AT);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		if (SurveyQuery::isSoftDeleteEnabled()) {
			$criteria->add(SurveyPeer::DELETED_AT, null, Criteria::ISNULL);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to surveys_survey
	 * by a foreign key with ON DELETE CASCADE
	 */
	public static function clearRelatedInstancePool()
	{
		// Invalidate objects in SurveyQuestionPeer instance pool, 
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(SurveyPeer::ID);
			if ($value) {
				$selectCriteria->add(SurveyPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the surveys_survey table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doForceDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += SurveyPeer::doOnDeleteCascade(new Criteria(SurveyPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doForceDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += SurveyPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = SurveyPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related SurveyQuestion objects
			$criteria = new Criteria(SurveyQuestionPeer::DATABASE_NAME);
			
			$criteria->add(SurveyQuestionPeer::SURVEYID, $obj->getId());
			$affectedRows += SurveyQuestionPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	{
		return SurveyQuery::isSoftDeleteEnabled();
	}
	
	/**
	 * Soft delete records, given a Survey or Criteria object OR a primary key value.
	 *
	 * @param			 mixed $values Criteria or Survey object or primary key or array of primary keys
	 *							which is used to create the DELETE statement
	 * @param			 PropelPDO $con the connection to use
	...
	public static function doSoftDelete($values, PropelPDO $con = null)
	{
		...
		$criteria->add(SurveyPeer::DELETED_AT, time());
		return SurveyPeer::doUpdate($criteria, $con);
	}
	
	/**
	 * Delete or soft delete records, depending on SurveyPeer::$softDelete
	 *
	 * @param			 mixed $values Criteria or Survey object or primary key or array of primary keys
	 *							which is used to create the DELETE statement
	 * @param			 PropelPDO $con the connection to use
	...
	{
		if (SurveyPeer::isSoftDeleteEnabled()) {
			return SurveyPeer::doSoftDelete($values, $con);
		} else {
			return SurveyPeer::doForceDelete($values, $con);
		} 
	}
	/**
	 * Method to soft delete all rows from the surveys_survey table.
	 *
	 * @param			 PropelPDO $con the connection to use
	 * @return		 int The number of affected rows (if supported by underlying database driver).
	 * @throws		 PropelException Any exceptions caught during processing will be
	...
	public static function doSoftDeleteAll(PropelPDO $con = null)
	{
		...
		$selectCriteria->add(SurveyPeer::DELETED_AT, null, Criteria::ISNULL);
		$selectCriteria->setDbName(SurveyPeer::DATABASE_NAME);
		$modifyCriteria = new Criteria();
		$modifyCriteria->add(SurveyPeer::DELETED_AT, time());
		return BasePeer::doUpdate($selectCriteria, $modifyCriteria, $con);
	}
	
	/**
	 * Delete or soft delete all records, depending on SurveyPeer::$softDelete
	 *
	 * @param			 PropelPDO $con the connection to use
	 * @return		 int	The number of affected rows (if supported by underlying database driver).
	 * @throws		 PropelException Any exceptions caught during processing will be
	...
	{
		if (SurveyPeer::isSoftDeleteEnabled()) {
			return SurveyPeer::doSoftDeleteAll($con);
		} else {
