...
/**
 * Base static class for performing query and update operations on the 'orders_orderItem' table.
 *
...
abstract class BaseOrderItemPeer {
	...
	const TABLE_NAME = 'orders_orderItem';

	/** the related Propel class for this table */
	const OM_CLASS = 'OrderItem';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'orders.classes.OrderItem';
	...
	const ID = 'orders_orderItem.ID';

	/** the column name for the ORDERID field */
	const ORDERID = 'orders_orderItem.ORDERID';

	/** the column name for the PRODUCTCODE field */
	const PRODUCTCODE = 'orders_orderItem.PRODUCTCODE';

	/** the column name for the PRICE field */
	const PRICE = 'orders_orderItem.PRICE';

	/** the column name for the QUANTITY field */
	const QUANTITY = 'orders_orderItem.QUANTITY';

	/**
	 * An identiy map to hold any loaded instances of OrderItem objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Orderid', 'Productcode', 'Price', 'Quantity', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'orderid', 'productcode', 'price', 'quantity', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ORDERID, self::PRODUCTCODE, self::PRICE, self::QUANTITY, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'ORDERID', 'PRODUCTCODE', 'PRICE', 'QUANTITY', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'orderId', 'productCode', 'price', 'quantity', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Orderid' => 1, 'Productcode' => 2, 'Price' => 3, 'Quantity' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'orderid' => 1, 'productcode' => 2, 'price' => 3, 'quantity' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ORDERID => 1, self::PRODUCTCODE => 2, self::PRICE => 3, self::QUANTITY => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'ORDERID' => 1, 'PRODUCTCODE' => 2, 'PRICE' => 3, 'QUANTITY' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'orderId' => 1, 'productCode' => 2, 'price' => 3, 'quantity' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(OrderItemPeer::ORDERID);
			$criteria->addSelectColumn(OrderItemPeer::PRODUCTCODE);
	 ...
	 *
	 * @param      OrderItem $value A OrderItem object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(OrderItem $obj, $key = null)
	{
	...
	/**
	 * Method to invalidate the instance pool of all tables related to orders_orderItem
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = OrderItemPeer::getOMClass(false);
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = OrderItemPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + OrderItemPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinOrder(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(OrderItemPeer::ORDERID, OrderPeer::ID, $join_behavior);
	...
	public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(OrderItemPeer::PRODUCTCODE, ProductPeer::CODE, $join_behavior);
	...
	public static function doSelectJoinOrder(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		OrderItemPeer::addSelectColumns($criteria);
		$startcol = (OrderItemPeer::NUM_COLUMNS - OrderItemPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		OrderItemPeer::addSelectColumns($criteria);
		$startcol2 = (OrderItemPeer::NUM_COLUMNS - OrderItemPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	{
		return $withPrefix ? OrderItemPeer::CLASS_DEFAULT : OrderItemPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a OrderItem or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a OrderItem or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the orders_orderItem table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a OrderItem or Criteria object OR a primary key value.
	 *
