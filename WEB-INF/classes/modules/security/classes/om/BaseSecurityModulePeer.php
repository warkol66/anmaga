...
abstract class BaseSecurityModulePeer {
	...
	const ACCESS = 'security_module.ACCESS';
	 ...
	 * @param      string $column The column name for current table. (i.e. SecurityModulePeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(SecurityModulePeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(SecurityModulePeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = SecurityModulePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return SecurityModulePeer::populateObjects(SecurityModulePeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      mixed $value A SecurityModule object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof SecurityModule) {
				$key = (string) $value->getModule();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or SecurityModule object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     SecurityModule Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a SecurityModule or Criteria object.
	 *
	 * @param      mixed $values Criteria or SecurityModule object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from SecurityModule object
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a SecurityModule or Criteria object.
	 *
	 * @param      mixed $values Criteria or SecurityModule object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the security_module table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a SecurityModule or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or SecurityModule object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given SecurityModule object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      SecurityModule $obj The object to validate.
	...
	public static function doValidate(SecurityModule $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(SecurityModulePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(SecurityModulePeer::TABLE_NAME);
		...
		return BasePeer::doValidate(SecurityModulePeer::DATABASE_NAME, SecurityModulePeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = SecurityModulePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(SecurityModulePeer::MODULE, $pk);

		$v = SecurityModulePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SecurityModulePeer::DATABASE_NAME);
			$criteria->add(SecurityModulePeer::MODULE, $pks, Criteria::IN);
			$objs = SecurityModulePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
