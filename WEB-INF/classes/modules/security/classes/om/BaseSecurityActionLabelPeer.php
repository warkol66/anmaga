...
abstract class BaseSecurityActionLabelPeer {
	...
	const ID = 'security_actionLabel.ID';

	/** the column name for the ACTION field */
	const ACTION = 'security_actionLabel.ACTION';

	/** the column name for the LANGUAGE field */
	const LANGUAGE = 'security_actionLabel.LANGUAGE';
	 ...
	 * @param      string $column The column name for current table. (i.e. SecurityActionLabelPeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(SecurityActionLabelPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(SecurityActionLabelPeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = SecurityActionLabelPeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return SecurityActionLabelPeer::populateObjects(SecurityActionLabelPeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      SecurityActionLabel $value A SecurityActionLabel object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(SecurityActionLabel $obj, $key = null)
	{
	 ...
	 *
	 * @param      mixed $value A SecurityActionLabel object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof SecurityActionLabel) {
				$key = serialize(array((string) $value->getId(), (string) $value->getAction()));
			} elseif (is_array($value) && count($value) === 2) {
				// assume we've been passed a primary key
				$key = serialize(array((string) $value[0], (string) $value[1]));
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or SecurityActionLabel object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     SecurityActionLabel Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a SecurityActionLabel or Criteria object.
	 *
	 * @param      mixed $values Criteria or SecurityActionLabel object containing data that is used to create the INSERT statement.
	...
	{
		if ($con === null) {
			$con = Propel::getConnection(SecurityActionLabelPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
		}

		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} else {
			$criteria = $values->buildCriteria(); // build Criteria from SecurityActionLabel object
		}

		if ($criteria->containsKey(SecurityActionLabelPeer::ID) && $criteria->keyContainsValue(SecurityActionLabelPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SecurityActionLabelPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a SecurityActionLabel or Criteria object.
	 *
	 * @param      mixed $values Criteria or SecurityActionLabel object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the security_actionLabel table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a SecurityActionLabel or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or SecurityActionLabel object or primary key or array of primary keys
	...
	/**
	 * Validates all modified columns of given SecurityActionLabel object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      SecurityActionLabel $obj The object to validate.
	 * @param      mixed $cols Column name or array of column names.
	 *
	 * @return     mixed TRUE if all columns are valid or the error message of the first invalid column.
	 */
	public static function doValidate(SecurityActionLabel $obj, $cols = null)
	{
		$columns = array();

		if ($cols) {
			$dbMap = Propel::getDatabaseMap(SecurityActionLabelPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(SecurityActionLabelPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(SecurityActionLabelPeer::DATABASE_NAME, SecurityActionLabelPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($id, $action, PropelPDO $con = null) {
		...
		$criteria->add(SecurityActionLabelPeer::ID, $id);
		$criteria->add(SecurityActionLabelPeer::ACTION, $action);
		$v = SecurityActionLabelPeer::doSelect($criteria, $con);
