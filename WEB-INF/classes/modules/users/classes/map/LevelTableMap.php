...
/**
 * This class defines the structure of the 'users_level' table.
 *
 *
 *
...
class LevelTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'users.classes.map.LevelTableMap';
	...
	{
    $this->addRelation('User', 'User', RelationMap::ONE_TO_MANY, array('id' => 'levelId', ), null, null);
	} // buildRelations()
