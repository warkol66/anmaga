    ...
    <tr>
      ...
      <td>
        <form action="Main.php" method="post" style="display:inline;"> 
          ...
          <input type="button" name="submit_go_remove_category" value="Borrar" onclick="if (confirm('Seguro que desea quitar la categoria?')) catalogProductsDoRemoveCategoriesX(this.form);" class="buttonImageDelete" /> 
        </form>
      </td>
    </tr>
  |-/foreach-|
