...
class UnitTableMap extends TableMap {
	 ...
	 */
	const CLASS_NAME = 'catalog.classes.map.UnitTableMap';
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('UNITQUANTITY', 'Unitquantity', 'INTEGER', true, null, null);
		// validators
	} // initialize()
	...
	{
    $this->addRelation('Product', 'Product', RelationMap::ONE_TO_MANY, array('id' => 'unitId', ), null, null);
	} // buildRelations()
