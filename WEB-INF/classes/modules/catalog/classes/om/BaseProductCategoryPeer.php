...
/**
 * Base static class for performing query and update operations on the 'catalog_productCategory' table.
 *
...
abstract class BaseProductCategoryPeer {
	...
	const TABLE_NAME = 'catalog_productCategory';

	/** the related Propel class for this table */
	const OM_CLASS = 'ProductCategory';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'catalog.classes.ProductCategory';
	...
	const PRODUCTCODE = 'catalog_productCategory.PRODUCTCODE';

	/** the column name for the CATEGORYID field */
	const CATEGORYID = 'catalog_productCategory.CATEGORYID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Productcode', 'Categoryid', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('productcode', 'categoryid', ),
		BasePeer::TYPE_COLNAME => array (self::PRODUCTCODE, self::CATEGORYID, ),
		BasePeer::TYPE_RAW_COLNAME => array ('PRODUCTCODE', 'CATEGORYID', ),
		BasePeer::TYPE_FIELDNAME => array ('productCode', 'categoryId', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Productcode' => 0, 'Categoryid' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('productcode' => 0, 'categoryid' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::PRODUCTCODE => 0, self::CATEGORYID => 1, ),
		BasePeer::TYPE_RAW_COLNAME => array ('PRODUCTCODE' => 0, 'CATEGORYID' => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('productCode' => 0, 'categoryId' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ProductCategoryPeer::PRODUCTCODE);
			$criteria->addSelectColumn(ProductCategoryPeer::CATEGORYID);
		} else {
	...
	public static function addInstanceToPool(ProductCategory $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getProductcode(), (string) $obj->getCategoryid()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof ProductCategory) {
				$key = serialize(array((string) $value->getProductcode(), (string) $value->getCategoryid()));
	...
	/**
	 * Method to invalidate the instance pool of all tables related to catalog_productCategory
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = ProductCategoryPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + ProductCategoryPeer::NUM_COLUMNS;
		} else {
	...
	public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProductCategoryPeer::CATEGORYID, CategoryPeer::ID, $join_behavior);
	...
	public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ProductCategoryPeer::PRODUCTCODE, ProductPeer::CODE, $join_behavior);
	...
	public static function doSelectJoinCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ProductCategoryPeer::addSelectColumns($criteria);
		$startcol = (ProductCategoryPeer::NUM_COLUMNS - ProductCategoryPeer::NUM_LAZY_LOAD_COLUMNS);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (ProductCategory) to the collection in $obj3 (Product)
	...
	{
		return $withPrefix ? ProductCategoryPeer::CLASS_DEFAULT : ProductCategoryPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a ProductCategory or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a ProductCategory or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ProductCategoryPeer::PRODUCTCODE);
			$value = $criteria->remove(ProductCategoryPeer::PRODUCTCODE);
			if ($value) {
				$selectCriteria->add(ProductCategoryPeer::PRODUCTCODE, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ProductCategoryPeer::TABLE_NAME);
			}

			$comparison = $criteria->getComparison(ProductCategoryPeer::CATEGORYID);
			$value = $criteria->remove(ProductCategoryPeer::CATEGORYID);
			if ($value) {
				$selectCriteria->add(ProductCategoryPeer::CATEGORYID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(ProductCategoryPeer::TABLE_NAME);
			}
	...
	/**
	 * Method to DELETE all rows from the catalog_productCategory table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a ProductCategory or Criteria object OR a primary key value.
	 *
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				$criterion = $criteria->getNewCriterion(ProductCategoryPeer::PRODUCTCODE, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(ProductCategoryPeer::CATEGORYID, $value[1]));
	 ...
	 * @return     ProductCategory
	 */
	public static function retrieveByPK($productcode, $categoryid, PropelPDO $con = null) {
		$_instancePoolKey = serialize(array((string) $productcode, (string) $categoryid));
		...
		$criteria->add(ProductCategoryPeer::PRODUCTCODE, $productcode);
		$criteria->add(ProductCategoryPeer::CATEGORYID, $categoryid);
