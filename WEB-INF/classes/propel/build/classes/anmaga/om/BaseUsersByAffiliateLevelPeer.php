...
abstract class BaseUsersByAffiliateLevelPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (UsersByAffiliateLevelPeer::ID, UsersByAffiliateLevelPeer::NAME, UsersByAffiliateLevelPeer::BITLEVEL, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (UsersByAffiliateLevelPeer::ID => 0, UsersByAffiliateLevelPeer::NAME => 1, UsersByAffiliateLevelPeer::BITLEVEL => 2, ),
	...
	public static function getMapBuilder()
	{
		...
		return BasePeer::getMapBuilder('anmaga.map.UsersByAffiliateLevelMapBuilder');
	}
	/**
	...
	{
		return str_replace(UsersByAffiliateLevelPeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UsersByAffiliateLevelPeer::ID);

		$criteria->addSelectColumn(UsersByAffiliateLevelPeer::NAME);

		$criteria->addSelectColumn(UsersByAffiliateLevelPeer::BITLEVEL);
	...
	{
		return UsersByAffiliateLevelPeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from UsersByAffiliateLevel object
		}

		$criteria->remove(UsersByAffiliateLevelPeer::ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(UsersByAffiliateLevelPeer::ID);
			$selectCriteria->add(UsersByAffiliateLevelPeer::ID, $criteria->remove(UsersByAffiliateLevelPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += BasePeer::doDeleteAll(UsersByAffiliateLevelPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 *
	 * @param mixed $values Criteria or UsersByAffiliateLevel object or primary key or array of primary keys
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(UsersByAffiliateLevelPeer::ID, (array) $values, Criteria::IN);
		}
	...
	public static function doValidate(UsersByAffiliateLevel $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(UsersByAffiliateLevelPeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(UsersByAffiliateLevelPeer::TABLE_NAME);
		...
		return BasePeer::doValidate(UsersByAffiliateLevelPeer::DATABASE_NAME, UsersByAffiliateLevelPeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, $con = null)
	{
		...
		$criteria->add(UsersByAffiliateLevelPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(UsersByAffiliateLevelPeer::ID, $pks, Criteria::IN);
			$objs = UsersByAffiliateLevelPeer::doSelect($criteria, $con);
		}
		return $objs;
	}

} // BaseUsersByAffiliateLevelPeer
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('anmaga.map.UsersByAffiliateLevelMapBuilder');
}
