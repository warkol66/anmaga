...
// actual class may be a subclass -- as returned by ActionLogPeer::getOMClass()
include_once 'anmaga/ActionLog.php';

/**
 * Base static class for performing query and update operations on the 'log_actionLog' table.
 *
 * logs del sistema
 *
...
abstract class BaseActionLogPeer {
	...
	const TABLE_NAME = 'log_actionLog';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'anmaga.ActionLog';
	...
	const ID = 'log_actionLog.ID';

	/** the column name for the USERID field */
	const USERID = 'log_actionLog.USERID';

	/** the column name for the AFFILIATEID field */
	const AFFILIATEID = 'log_actionLog.AFFILIATEID';

	/** the column name for the DATETIME field */
	const DATETIME = 'log_actionLog.DATETIME';

	/** the column name for the ACTION field */
	const ACTION = 'log_actionLog.ACTION';

	/** the column name for the MESSAGE field */
	const MESSAGE = 'log_actionLog.MESSAGE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Userid', 'Affiliateid', 'Datetime', 'Action', 'Message', ),
		BasePeer::TYPE_COLNAME => array (ActionLogPeer::ID, ActionLogPeer::USERID, ActionLogPeer::AFFILIATEID, ActionLogPeer::DATETIME, ActionLogPeer::ACTION, ActionLogPeer::MESSAGE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'userId', 'affiliateId', 'datetime', 'action', 'message', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Userid' => 1, 'Affiliateid' => 2, 'Datetime' => 3, 'Action' => 4, 'Message' => 5, ),
		BasePeer::TYPE_COLNAME => array (ActionLogPeer::ID => 0, ActionLogPeer::USERID => 1, ActionLogPeer::AFFILIATEID => 2, ActionLogPeer::DATETIME => 3, ActionLogPeer::ACTION => 4, ActionLogPeer::MESSAGE => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'userId' => 1, 'affiliateId' => 2, 'datetime' => 3, 'action' => 4, 'message' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	{
		include_once 'anmaga/map/ActionLogMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.ActionLogMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ActionLogPeer::MESSAGE);

	}

	const COUNT = 'COUNT(log_actionLog.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT log_actionLog.ID)';
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ActionLogPeer::USERID, UserPeer::ID);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinSecurityAction(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ActionLogPeer::ACTION, SecurityActionPeer::ACTION);
	...
	public static function doSelectJoinUser(Criteria $c, $con = null)
	{
		...
		$startcol = (ActionLogPeer::NUM_COLUMNS - ActionLogPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		UserPeer::addSelectColumns($c);

		$c->addJoin(ActionLogPeer::USERID, UserPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addActionLog($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initActionLogs();
				$obj2->addActionLog($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinSecurityAction(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		$c->addJoin(ActionLogPeer::ACTION, SecurityActionPeer::ACTION);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getSecurityAction(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addActionLog($obj1); //CHECKME
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		ActionLogPeer::addSelectColumns($c);
		$startcol2 = (ActionLogPeer::NUM_COLUMNS - ActionLogPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		UserPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + UserPeer::NUM_COLUMNS;

		SecurityActionPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + SecurityActionPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getSecurityAction(); // CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addActionLog($obj1); // CHECKME
					break;
				}
			}
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptSecurityAction(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptUser(Criteria $c, $con = null)
	{
		...
		SecurityActionPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + SecurityActionPeer::NUM_COLUMNS;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptSecurityAction(Criteria $c, $con = null)
	{
		$c = clone $c;
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(ActionLogPeer::ID); // remove pkey col since this table uses auto-increment
	...
	/**
	 * Method to DELETE all rows from the log_actionLog table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/ActionLogMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.ActionLogMapBuilder');
}
