...
abstract class BaseAffiliatePeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(AffiliateMapBuilder::CLASS_NAME);
	}
	 ...
	 * @param Connection $con
	 * @return Affiliate	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or Affiliate object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of Affiliate objects pre-filled with their
	 * AffiliateInfo objects.
	 *
	...
	public static function doSelectJoinAffiliateInfo(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getAffiliateInfo();
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addAffiliate($obj1);
					break;
				}
			}
			if ($newObject) {
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(AffiliateMapBuilder::CLASS_NAME);
}
