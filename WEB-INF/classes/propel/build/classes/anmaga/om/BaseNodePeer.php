...
abstract class BaseNodePeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(NodeMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::KIND);
		$criteria->addSelectColumn(self::OBJECTID);
		$criteria->addSelectColumn(self::PARENTID);
		$criteria->addSelectColumn(self::POSITION);
	}
	 ...
	 * @param Connection $con
	 * @return Node	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or Node object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(NodeMapBuilder::CLASS_NAME);
}
