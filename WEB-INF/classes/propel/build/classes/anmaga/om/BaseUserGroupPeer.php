...
abstract class BaseUserGroupPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(UserGroupMapBuilder::CLASS_NAME);
	}
	 ...
	 * @param Connection $con
	 * @return UserGroup	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or UserGroup object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of UserGroup objects pre-filled with their
	 * User objects.
	 *
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(UserGroupMapBuilder::CLASS_NAME);
}
