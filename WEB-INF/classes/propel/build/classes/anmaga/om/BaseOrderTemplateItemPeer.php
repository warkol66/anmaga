...
abstract class BaseOrderTemplateItemPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(OrderTemplateItemMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::ORDERTEMPLATEID);
		$criteria->addSelectColumn(self::PRODUCTID);
	 ...
	 * @param Connection $con
	 * @return OrderTemplateItem	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or OrderTemplateItem object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of OrderTemplateItem objects pre-filled with their
	 * OrderTemplate objects.
	 *
	...
	public static function doSelectJoinOrderTemplate(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getOrderTemplate();
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(OrderTemplateItemMapBuilder::CLASS_NAME);
}
