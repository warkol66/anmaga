...
// actual class may be a subclass -- as returned by OrderTemplateItemPeer::getOMClass()
...
abstract class BaseOrderTemplateItemPeer {
	...
	const CLASS_DEFAULT = 'anmaga.OrderTemplateItem';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (OrderTemplateItemPeer::ID, OrderTemplateItemPeer::ORDERTEMPLATEID, OrderTemplateItemPeer::PRODUCTID, OrderTemplateItemPeer::PRICE, OrderTemplateItemPeer::QUANTITY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (OrderTemplateItemPeer::ID => 0, OrderTemplateItemPeer::ORDERTEMPLATEID => 1, OrderTemplateItemPeer::PRODUCTID => 2, OrderTemplateItemPeer::PRICE => 3, OrderTemplateItemPeer::QUANTITY => 4, ),
	...
	{
		include_once 'anmaga/map/OrderTemplateItemMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.OrderTemplateItemMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = OrderTemplateItemPeer::getTableMap();
	...
	const COUNT = 'COUNT(orders_orderTemplateItem.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT orders_orderTemplateItem.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(OrderTemplateItemPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(OrderTemplateItemPeer::COUNT);
		}
		...
		$rs = OrderTemplateItemPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return OrderTemplateItemPeer::populateObjects(OrderTemplateItemPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function populateObjects(ResultSet $rs)
	{
		...
		$cls = OrderTemplateItemPeer::getOMClass();
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinOrderTemplate(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(OrderTemplateItemPeer::ORDERTEMPLATEID, OrderTemplatePeer::ID);
	...
	public static function doCountJoinProduct(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(OrderTemplateItemPeer::PRODUCTID, ProductPeer::ID);
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinOrderTemplate(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		OrderTemplateItemPeer::addSelectColumns($c);
		$startcol = (OrderTemplateItemPeer::NUM_COLUMNS - OrderTemplateItemPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		OrderTemplatePeer::addSelectColumns($c);

		$c->addJoin(OrderTemplateItemPeer::ORDERTEMPLATEID, OrderTemplatePeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = OrderTemplateItemPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getOrderTemplate(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addOrderTemplateItem($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initOrderTemplateItems();
				$obj2->addOrderTemplateItem($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinProduct(Criteria $c, $con = null)
	{
		...
		$c->addJoin(OrderTemplateItemPeer::PRODUCTID, ProductPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		OrderTemplateItemPeer::addSelectColumns($c);
		$startcol2 = (OrderTemplateItemPeer::NUM_COLUMNS - OrderTemplateItemPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		OrderTemplatePeer::addSelectColumns($c);
		$startcol3 = $startcol2 + OrderTemplatePeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addOrderTemplateItem($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj3->initOrderTemplateItems();
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptOrderTemplate(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptOrderTemplate(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addOrderTemplateItem($obj1);
					break;
				}
			}
	...
	{
		return OrderTemplateItemPeer::CLASS_DEFAULT;
	}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(OrderTemplateItemPeer::ID); // remove pkey col since this table uses auto-increment
	...
	public static function doUpdate($values, $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(OrderTemplateItemPeer::ID, $criteria->remove(OrderTemplateItemPeer::ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->begin();
			$affectedRows += BasePeer::doDeleteAll(OrderTemplateItemPeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollback();
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof OrderTemplateItem) {
...
if (Propel::isInit()) {
	...
	try {
		BaseOrderTemplateItemPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'anmaga/map/OrderTemplateItemMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.OrderTemplateItemMapBuilder');
}
