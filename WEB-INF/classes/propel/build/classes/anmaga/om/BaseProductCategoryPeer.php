...
abstract class BaseProductCategoryPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(ProductCategoryMapBuilder::CLASS_NAME);
	}
	 ...
	 * @param Connection $con
	 * @return ProductCategory	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or ProductCategory object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(ProductCategoryMapBuilder::CLASS_NAME);
}
