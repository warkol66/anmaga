...
abstract class BaseProductPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Description', 'Price', 'Unitid', 'Measureunitid', 'Active', 'Ordercode', ),
		BasePeer::TYPE_COLNAME => array (ProductPeer::ID, ProductPeer::CODE, ProductPeer::DESCRIPTION, ProductPeer::PRICE, ProductPeer::UNITID, ProductPeer::MEASUREUNITID, ProductPeer::ACTIVE, ProductPeer::ORDERCODE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'description', 'price', 'unitId', 'measureUnitId', 'active', 'orderCode', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Description' => 2, 'Price' => 3, 'Unitid' => 4, 'Measureunitid' => 5, 'Active' => 6, 'Ordercode' => 7, ),
		BasePeer::TYPE_COLNAME => array (ProductPeer::ID => 0, ProductPeer::CODE => 1, ProductPeer::DESCRIPTION => 2, ProductPeer::PRICE => 3, ProductPeer::UNITID => 4, ProductPeer::MEASUREUNITID => 5, ProductPeer::ACTIVE => 6, ProductPeer::ORDERCODE => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'description' => 2, 'price' => 3, 'unitId' => 4, 'measureUnitId' => 5, 'active' => 6, 'orderCode' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function getMapBuilder()
	{
		...
		return BasePeer::getMapBuilder('anmaga.map.ProductMapBuilder');
	}
	/**
	...
	public static function doCountJoinUnit(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ProductPeer::UNITID, UnitPeer::ID);
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinMeasureUnit(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ProductPeer::MEASUREUNITID, MeasureUnitPeer::ID);
	...
	public static function doSelectJoinMeasureUnit(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getMeasureUnit(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addProduct($obj1); //CHECKME
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		MeasureUnitPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + MeasureUnitPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getMeasureUnit(); // CHECKME
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinAllExceptMeasureUnit(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptUnit(Criteria $c, $con = null)
	{
		...
		MeasureUnitPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + MeasureUnitPeer::NUM_COLUMNS;
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptMeasureUnit(Criteria $c, $con = null)
	{
		$c = clone $c;
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('anmaga.map.ProductMapBuilder');
}
