...
abstract class BaseAffiliate extends BaseObject  implements Persistent {
	 ...
	 * actually need in Affiliate.
	 */
	public function getOrderStateChangesJoinUserByAffiliate($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseOrderStateChangePeer.php';
		if ($criteria === null) {
		...
		if ($this->collOrderStateChanges === null) {
			if ($this->isNew()) {
				...
				$this->collOrderStateChanges = OrderStateChangePeer::doSelectJoinUserByAffiliate($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
