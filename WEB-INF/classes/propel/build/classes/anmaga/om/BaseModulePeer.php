...
abstract class BaseModulePeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(ModuleMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::ALWAYSACTIVE);
	}
	 ...
	 * @param Connection $con
	 * @return Module	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	...
	{			
		...
		if ($values instanceof Criteria) {
			$criteria = $values;
			$selectCriteria->put(self::NAME, $criteria->remove(self::NAME));
	 ...
	 *
	 * @param mixed $values Criteria or Module object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(self::NAME, $pks, Criteria::IN);
	...
	public static function doSelectJoinModuleDependency(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getModuleDependency();
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addModule($obj1);
					break;
				}
			}
			if ($newObject) {
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(ModuleMapBuilder::CLASS_NAME);
}
