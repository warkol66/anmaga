...
// actual class may be a subclass -- as returned by ModulePeer::getOMClass()
...
abstract class BaseModulePeer {
	...
	const CLASS_DEFAULT = 'anmaga.Module';
	...
	const LABEL = 'modules_module.LABEL';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'modules_module.DESCRIPTION';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Name', 'Label', 'Description', 'Active', 'Alwaysactive', ),
		BasePeer::TYPE_COLNAME => array (ModulePeer::NAME, ModulePeer::LABEL, ModulePeer::DESCRIPTION, ModulePeer::ACTIVE, ModulePeer::ALWAYSACTIVE, ),
		BasePeer::TYPE_FIELDNAME => array ('name', 'label', 'description', 'active', 'alwaysActive', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Name' => 0, 'Label' => 1, 'Description' => 2, 'Active' => 3, 'Alwaysactive' => 4, ),
		BasePeer::TYPE_COLNAME => array (ModulePeer::NAME => 0, ModulePeer::LABEL => 1, ModulePeer::DESCRIPTION => 2, ModulePeer::ACTIVE => 3, ModulePeer::ALWAYSACTIVE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('name' => 0, 'label' => 1, 'description' => 2, 'active' => 3, 'alwaysActive' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	{
		include_once 'anmaga/map/ModuleMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.ModuleMapBuilder');
	}
	/**
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ModulePeer::LABEL);
	...
	const COUNT = 'COUNT(modules_module.NAME)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT modules_module.NAME)';
	...
	/**
	 * Returns the number of rows matching criteria, joining the related ModuleDependency table
	 *
	 * @param      Criteria $c
	 * @param      boolean $distinct Whether to select only distinct columns (You can also set DISTINCT modifier in Criteria).
	 * @param      Connection $con
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinModuleDependency(Criteria $criteria, $distinct = false, $con = null)
	{
		// we're going to modify criteria, so copy it first
		$criteria = clone $criteria;
		...
		$criteria->addJoin(ModulePeer::NAME, ModuleDependencyPeer::MODULE);
	...
	/**
	 * Selects a collection of Module objects pre-filled with their ModuleDependency objects.
	 *
	 * @return     array Array of Module objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinModuleDependency(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		$startcol = (ModulePeer::NUM_COLUMNS - ModulePeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		ModuleDependencyPeer::addSelectColumns($c);

		$c->addJoin(ModulePeer::NAME, ModuleDependencyPeer::MODULE);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getModuleDependency(); //CHECKME
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					// e.g. $author->addBookRelatedByBookId()
					$temp_obj2->addModule($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initModules();
				$obj2->addModule($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		ModuleDependencyPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + ModuleDependencyPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			$obj1->hydrate($rs);
				...
				// Add objects for joined ModuleDependency rows
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/ModuleMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.ModuleMapBuilder');
}
