...
abstract class BaseUserByAffiliate extends BaseObject  implements Persistent {
		...
		if ($this->collOrderStateChanges === null) {
			if ($this->isNew()) {
			   $this->collOrderStateChanges = array();
				...
				$criteria->add(OrderStateChangePeer::USERID, $this->getId());
	 ...
	 * actually need in UserByAffiliate.
	 */
	public function getOrderStateChangesJoinOrder($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseOrderStateChangePeer.php';
		if ($criteria === null) {
		...
		if ($this->collOrderStateChanges === null) {
			if ($this->isNew()) {
				...
				$this->collOrderStateChanges = OrderStateChangePeer::doSelectJoinOrder($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
