...
abstract class BaseUsersByAffiliateUserInfo extends BaseObject  implements Persistent {
	...
	public function setMailaddress($v)
	{
		...
		if ($this->mailaddress !== $v) {
			$this->mailaddress = $v;
			$this->modifiedColumns[] = UsersByAffiliateUserInfoPeer::MAILADDRESS;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 4; // 4 = UsersByAffiliateUserInfoPeer::NUM_COLUMNS - UsersByAffiliateUserInfoPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += UsersByAffiliateUserInfoPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = UsersByAffiliateUserInfoPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsersByAffiliateUserInfoPeer::MAILADDRESS)) $criteria->add(UsersByAffiliateUserInfoPeer::MAILADDRESS, $this->mailaddress);
	 ...
	 * objects.
	 *
	 * @param object $copyObj An object of UsersByAffiliateUserInfo (or compatible) type.
