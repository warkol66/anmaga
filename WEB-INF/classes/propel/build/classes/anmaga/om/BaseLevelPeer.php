...
abstract class BaseLevelPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (LevelPeer::ID, LevelPeer::NAME, LevelPeer::BITLEVEL, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (LevelPeer::ID => 0, LevelPeer::NAME => 1, LevelPeer::BITLEVEL => 2, ),
	...
	public static function getMapBuilder()
	{
		...
		return BasePeer::getMapBuilder('anmaga.map.LevelMapBuilder');
	}
	/**
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(LevelPeer::ID); // remove pkey col since this table uses auto-increment
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder('anmaga.map.LevelMapBuilder');
}
