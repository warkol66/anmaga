...
abstract class BaseUserPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(UserMapBuilder::CLASS_NAME);
	}
	 ...
	 * @param Connection $con
	 * @return User	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or User object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(UserMapBuilder::CLASS_NAME);
}
