...
// actual class may be a subclass -- as returned by OrderItemPeer::getOMClass()
...
abstract class BaseOrderItemPeer {
	...
	const CLASS_DEFAULT = 'anmaga.OrderItem';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (OrderItemPeer::ID, OrderItemPeer::ORDERID, OrderItemPeer::PRODUCTID, OrderItemPeer::PRICE, OrderItemPeer::QUANTITY, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (OrderItemPeer::ID => 0, OrderItemPeer::ORDERID => 1, OrderItemPeer::PRODUCTID => 2, OrderItemPeer::PRICE => 3, OrderItemPeer::QUANTITY => 4, ),
	...
	{
		include_once 'anmaga/map/OrderItemMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.OrderItemMapBuilder');
	}
	/**
	...
	const COUNT = 'COUNT(orders_orderItem.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT orders_orderItem.ID)';
	...
	public static function doCountJoinOrder(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(OrderItemPeer::ORDERID, OrderPeer::ID);
	...
	public static function doSelectJoinOrder(Criteria $c, $con = null)
	{
		...
		$c->addJoin(OrderItemPeer::ORDERID, OrderPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addOrderItem($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initOrderItems();
				$obj2->addOrderItem($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinProduct(Criteria $c, $con = null)
	{
		...
		$c->addJoin(OrderItemPeer::PRODUCTID, ProductPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addOrderItem($obj1); // CHECKME
					break;
				}
			}
	...
	public static function doInsert($values, $con = null)
	{
		...
		$criteria->remove(OrderItemPeer::ID); // remove pkey col since this table uses auto-increment
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; // rename for clarity
		} elseif ($values instanceof OrderItem) {
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/OrderItemMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.OrderItemMapBuilder');
}
