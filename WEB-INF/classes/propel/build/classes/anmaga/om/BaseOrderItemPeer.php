...
abstract class BaseOrderItemPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(OrderItemMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::ORDERID);
	 ...
	 * @param Connection $con
	 * @return OrderItem	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or OrderItem object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of OrderItem objects pre-filled with their
	 * Order objects.
	 *
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(OrderItemMapBuilder::CLASS_NAME);
}
