...
abstract class BaseBranchPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Affiliateid', 'Number', 'Name', 'Phone', 'Contact', 'Contactemail', 'Memo', ),
		BasePeer::TYPE_COLNAME => array (BranchPeer::ID, BranchPeer::AFFILIATEID, BranchPeer::NUMBER, BranchPeer::NAME, BranchPeer::PHONE, BranchPeer::CONTACT, BranchPeer::CONTACTEMAIL, BranchPeer::MEMO, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'affiliateId', 'number', 'name', 'phone', 'contact', 'contactEmail', 'memo', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Affiliateid' => 1, 'Number' => 2, 'Name' => 3, 'Phone' => 4, 'Contact' => 5, 'Contactemail' => 6, 'Memo' => 7, ),
		BasePeer::TYPE_COLNAME => array (BranchPeer::ID => 0, BranchPeer::AFFILIATEID => 1, BranchPeer::NUMBER => 2, BranchPeer::NAME => 3, BranchPeer::PHONE => 4, BranchPeer::CONTACT => 5, BranchPeer::CONTACTEMAIL => 6, BranchPeer::MEMO => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'affiliateId' => 1, 'number' => 2, 'name' => 3, 'phone' => 4, 'contact' => 5, 'contactEmail' => 6, 'memo' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
