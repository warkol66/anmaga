...
abstract class BaseBranchPeer
{
	...
	public static function getMapBuilder()		
	{
		...
		return BasePeer::getMapBuilder(BranchMapBuilder::CLASS_NAME);
	}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(self::NUMBER);
	 ...
	 * @param Connection $con
	 * @return Branch	 * @throws PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	 ...
	 *
	 * @param mixed $values Criteria or Branch object or primary key which is used to create the DELETE statement 
	 * @param Connection $con the connection to use
	...
	/**
	 * Selects a collection of Branch objects pre-filled with their
	 * Affiliate objects.
	 *
...
if (Propel::isInit()) {
	...
	Propel::registerMapBuilder(BranchMapBuilder::CLASS_NAME);
}
