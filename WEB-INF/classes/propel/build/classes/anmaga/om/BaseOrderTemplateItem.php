...
// (on-demand) include_once 'anmaga/OrderTemplate.php';
// (on-demand) include_once 'anmaga/OrderTemplatePeer.php';
 ...
 * extended; all references should be to OrderTemplateItem class. 
 * 
 * @package anmaga 
 */
abstract class BaseOrderTemplateItem extends BaseObject implements Persistent {
	...
	public function getOrderTemplate($con = null)
	{
		...
		if ($this->aOrderTemplate === null && ($this->ordertemplateid !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   $obj->addOrderTemplateItems($this);
			 */
		}
	 ...
	 * @throws PropelException
	 */
	public function setOrderTemplateKey($key)
	{

		$this->setOrdertemplateid( (int) $key);			
	 ...
	 */
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aOrderTemplate !== null) {
				if ($this->aOrderTemplate->isModified()) $this->aOrderTemplate->save($con);
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					OrderTemplateItemPeer::doUpdate($this, $con);
				}			
	...
	public function validate($columns = null)
	{
	  if ($columns)
	  {
		return OrderTemplateItemPeer::doValidate($this, $columns);
	  }
	...
	protected function doValidate()
	{
		if (! $this->alreadyInValidation) {
			...
			// foreign key reference.
			if ($this->aOrderTemplate !== null) {
				if (($retval = $this->aOrderTemplate->validate()) !== true) {
			...
			if (($retval = OrderTemplateItemPeer::doValidate($this)) !== true) {
				$failureMap = array_merge($failureMap, $retval);
			}
