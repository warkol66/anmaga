...
abstract class BaseUsersByAffiliateGroupCategory extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			return $startcol + 2; // 2 = UsersByAffiliateGroupCategoryPeer::NUM_COLUMNS - UsersByAffiliateGroupCategoryPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsersByAffiliateGroup !== null) {
				if ($this->aUsersByAffiliateGroup->isModified()) {
					$affectedRows += $this->aUsersByAffiliateGroup->save($con);
				}
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += UsersByAffiliateGroupCategoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsersByAffiliateGroup !== null) {
				if (!$this->aUsersByAffiliateGroup->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsersByAffiliateGroup->getValidationFailures());
				}
			}
			...
			if (($retval = UsersByAffiliateGroupCategoryPeer::doValidate($this, $columns)) !== true) {
	 ...
	 * objects.
	 *
	 * @param object $copyObj An object of UsersByAffiliateGroupCategory (or compatible) type.
	...
	public function getUsersByAffiliateGroup($con = null)
	{
		...
		include_once 'anmaga/om/BaseUsersByAffiliateGroupPeer.php';
		...
		if ($this->aUsersByAffiliateGroup === null && ($this->groupid !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   $obj->addUsersByAffiliateGroups($this);
			 */
		}
...
} // BaseUsersByAffiliateGroupCategory
