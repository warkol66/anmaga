...
abstract class BaseSecurityAction extends BaseObject  implements Persistent {
	...
	public function setLabel($v)
	{
		...
		if ($this->label !== $v) {
			$this->label = $v;
			$this->modifiedColumns[] = SecurityActionPeer::LABEL;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->accessusersbyaffiliate = $rs->getInt($startcol + 5);

			$this->active = $rs->getInt($startcol + 6);

			$this->pair = $rs->getString($startcol + 7);
			...
			return $startcol + 8; // 8 = SecurityActionPeer::NUM_COLUMNS - SecurityActionPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SecurityActionPeer::LABEL)) $criteria->add(SecurityActionPeer::LABEL, $this->label);
