...
class UserInfoMapBuilder {
    ...
    public function doBuild()
    {
		...
		$tMap->addColumn('SURNAME', 'Surname', 'string', CreoleTypes::VARCHAR, false);

		$tMap->addColumn('MAILADDRESS', 'Mailaddress', 'string', CreoleTypes::VARCHAR, false);
