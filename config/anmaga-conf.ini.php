...
// from XML runtime conf file C:\apache\htdocs2\anmaga\branches\anmaga_update\WEB-INF\propel\runtime-conf.xml
$conf = array (
  'datasources' => 
  array (
    'anmaga' => 
    array (
      ...
      'connection' => 
      array (
        'dsn' => 'mysql:host=localhost; dbname=anmaga_update',
        'user' => 'root',
        'password' => 'vertrigo',
      ),
    ),
