<?php
/*
* $Header: /PHPMVC/phpmvc-base/WEB-INF/GlobalPrependEx.php,v 1.3 2006/05/17 22:51:57 who Exp $
* $Revision: 1.3 $
* $Date: 2006/05/17 22:51:57 $
*
* ====================================================================
*
...
// Authentication
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/PhpMVC_Auth_Const.php';
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/AuthenticatorBase.php';
#include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/BasicAuthenticator.php';
#include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/DigestAuthenticator.php';
#include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/FormAuthenticator.php';
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/ServiceAuthenticator.php';
#include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/authenticator/SSLAuthenticator.php';

include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/realm/LoginConfig.php';
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/realm/Principal.php';
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/realm/GenericPrincipal.php';
#include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/realm/RealmDataBroker_Pear.php';
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/realm/RealmBase.php';
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/realm/DataSourceRealm.php';
...
include_once $appServerRootDir.'/WEB-INF/classes/phpmvc/plugins/SmartyMLPlugInDriver.php';
include_once $appServerRootDir.'/WEB-INF/lib/smarty/Smarty.class.php';
include_once $appServerRootDir.'/WEB-INF/lib/smarty/SmartyML.class.php';
