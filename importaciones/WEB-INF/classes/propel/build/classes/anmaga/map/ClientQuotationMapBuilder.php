...
/**
 * This class adds structure of 'import_clientQuotation' table to 'anmaga' DatabaseMap object.
 *
 *
 ...
 * @package    anmaga.map
 */
class ClientQuotationMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'anmaga.map.ClientQuotationMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('import_clientQuotation');
