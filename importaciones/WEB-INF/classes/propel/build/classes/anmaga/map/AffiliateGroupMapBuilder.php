...
/**
 * This class adds structure of 'affiliates_group' table to 'anmaga' DatabaseMap object.
 *
 *
 ...
 * @package    anmaga.map
 */
class AffiliateGroupMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'anmaga.map.AffiliateGroupMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('affiliates_group');
