...
abstract class BaseProduct extends BaseObject  implements Persistent {
	...
	public function setSupplierid($v)
	{
		...
		if ($this->supplierid !== $v) {
			$this->supplierid = $v;
			$this->modifiedColumns[] = ProductPeer::SUPPLIERID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->supplierid = $rs->getInt($startcol + 4);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductPeer::SUPPLIERID)) $criteria->add(ProductPeer::SUPPLIERID, $this->supplierid);
