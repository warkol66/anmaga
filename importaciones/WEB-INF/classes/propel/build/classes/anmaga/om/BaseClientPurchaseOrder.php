...
include_once 'anmaga/ClientPurchaseOrderPeer.php';
...
abstract class BaseClientPurchaseOrder extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->clientquotationid = $rs->getInt($startcol + 3);

			$this->status = $rs->getInt($startcol + 4);

			$this->timestampstatus = $rs->getTimestamp($startcol + 5, null);
	 ...
	 * Otherwise if this ClientPurchaseOrder has previously
		...
		if ($this->collClientPurchaseOrderItems === null) {
			if ($this->isNew()) {
			   $this->collClientPurchaseOrderItems = array();
				...
				$criteria->add(ClientPurchaseOrderItemPeer::CLIENTPURCHASEORDERID, $this->getId());
