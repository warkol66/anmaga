...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	/**
	 * Collection to store aggregation of collClientQuotations.
	 * @var        array
	 */
	protected $collClientQuotations;

	/**
	 * The criteria used to select the current contents of collClientQuotations.
	 * @var        Criteria
	 */
	protected $lastClientQuotationCriteria = null;
	...
	/**
	 * Temporary storage of collClientQuotations to save a possible db hit in
	 * the event objects are add to the collection, but the
	 * complete collection is never requested.
	 * @return     void
	 */
	 ...
	 * @throws     PropelException
	 */
	public function getClientQuotations($criteria = null, $con = null)
	{
		// include the Peer class
	...
	/**
	 * Returns the number of related ClientQuotations.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      Connection $con
	 * @throws     PropelException
	 */
	public function countClientQuotations($criteria = null, $distinct = false, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseClientQuotationPeer.php';
		if ($criteria === null) {
		...
		return ClientQuotationPeer::doCount($criteria, $distinct, $con);
	}
