...
include_once 'anmaga/SupplierPurchaseOrderPeer.php';
...
abstract class BaseSupplierPurchaseOrder extends BaseObject  implements Persistent {
	 ...
	 * Otherwise if this SupplierPurchaseOrder has previously
		...
		if ($this->collPurchaseOrderItems === null) {
			if ($this->isNew()) {
			   $this->collPurchaseOrderItems = array();
				...
				$criteria->add(PurchaseOrderItemPeer::SUPPLIERPURCHASEORDERID, $this->getId());
