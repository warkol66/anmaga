...
include_once 'anmaga/PurchaseOrderPeer.php';

/**
 * Base class that represents a row from the 'import_purchaseOrder' table.
 *
 ...
 * @package    anmaga.om
 */
abstract class BasePurchaseOrder extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::ID;
		}
	...
	public function setCreatedat($v)
	{
		...
		if ($this->createdat !== $ts) {
			$this->createdat = $ts;
			$this->modifiedColumns[] = PurchaseOrderPeer::CREATEDAT;
		}
	...
	public function setSupplierid($v)
	{
		...
		if ($this->supplierid !== $v) {
			$this->supplierid = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::SUPPLIERID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = PurchaseOrderPeer::STATUS;
		}
	...
	public function setTimestampstatus($v)
	{
		...
		if ($this->timestampstatus !== $ts) {
			...
			$this->modifiedColumns[] = PurchaseOrderPeer::TIMESTAMPSTATUS;
		}
	...
	public function setSupplierquotationid($v)
	{
		...
		if ($this->supplierquotationid !== $v) {
			...
			$this->modifiedColumns[] = PurchaseOrderPeer::SUPPLIERQUOTATIONID;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->supplierquotationid = $rs->getInt($startcol + 5);
			...
			return $startcol + 6; // 6 = PurchaseOrderPeer::NUM_COLUMNS - PurchaseOrderPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PurchaseOrder object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			PurchaseOrderPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PurchaseOrderPeer::doInsert($this, $con);
					...
					$affectedRows += PurchaseOrderPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PurchaseOrderPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchaseOrderPeer::ID)) $criteria->add(PurchaseOrderPeer::ID, $this->id);
		if ($this->isColumnModified(PurchaseOrderPeer::CREATEDAT)) $criteria->add(PurchaseOrderPeer::CREATEDAT, $this->createdat);
		if ($this->isColumnModified(PurchaseOrderPeer::SUPPLIERID)) $criteria->add(PurchaseOrderPeer::SUPPLIERID, $this->supplierid);
		if ($this->isColumnModified(PurchaseOrderPeer::STATUS)) $criteria->add(PurchaseOrderPeer::STATUS, $this->status);
		if ($this->isColumnModified(PurchaseOrderPeer::TIMESTAMPSTATUS)) $criteria->add(PurchaseOrderPeer::TIMESTAMPSTATUS, $this->timestampstatus);
		if ($this->isColumnModified(PurchaseOrderPeer::SUPPLIERQUOTATIONID)) $criteria->add(PurchaseOrderPeer::SUPPLIERQUOTATIONID, $this->supplierquotationid);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PurchaseOrderPeer::ID, $this->id);
	 ...
	 *
	 * @return     PurchaseOrderPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PurchaseOrderPeer();
		}
		return self::$peer;
	}
		...
		if ($this->collPurchaseOrderItems === null) {
			if ($this->isNew()) {
			   $this->collPurchaseOrderItems = array();
				...
				$criteria->add(PurchaseOrderItemPeer::PURCHASEORDERID, $this->getId());
	 ...
	 */
	public function getPurchaseOrderItemsJoinProduct($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BasePurchaseOrderItemPeer.php';
		if ($criteria === null) {
		...
		if ($this->collPurchaseOrderItems === null) {
			if ($this->isNew()) {
				...
				$this->collPurchaseOrderItems = PurchaseOrderItemPeer::doSelectJoinProduct($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
