...
abstract class BaseProductPeer {
	...
	public static function doCountJoinSupplier(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ProductPeer::SUPPLIERID, SupplierPeer::ID);
	...
	/**
	 * Selects a collection of Product objects pre-filled with their Supplier objects.
	 *
	...
	public static function doSelectJoinSupplier(Criteria $c, $con = null)
	{
		...
		$c->addJoin(ProductPeer::SUPPLIERID, SupplierPeer::ID);
