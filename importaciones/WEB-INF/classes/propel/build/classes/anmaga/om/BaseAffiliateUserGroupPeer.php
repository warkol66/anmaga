...
// actual class may be a subclass -- as returned by AffiliateUserGroupPeer::getOMClass()
include_once 'anmaga/AffiliateUserGroup.php';
...
abstract class BaseAffiliateUserGroupPeer {
	...
	const CLASS_DEFAULT = 'anmaga.AffiliateUserGroup';
	...
	{
		include_once 'anmaga/map/AffiliateUserGroupMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.AffiliateUserGroupMapBuilder');
	}
	/**
	...
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = AffiliateUserGroupPeer::getTableMap();
	...
	const COUNT = 'COUNT(affiliates_userGroup.USERID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT affiliates_userGroup.USERID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(AffiliateUserGroupPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(AffiliateUserGroupPeer::COUNT);
		}
		...
		$rs = AffiliateUserGroupPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	{
		return AffiliateUserGroupPeer::populateObjects(AffiliateUserGroupPeer::doSelectRS($criteria, $con));
	}
	/**
	...
	public static function doCountJoinAffiliateUser(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(AffiliateUserGroupPeer::USERID, AffiliateUserPeer::ID);
	...
	public static function doCountJoinAffiliateGroup(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(AffiliateUserGroupPeer::GROUPID, AffiliateGroupPeer::ID);
	...
	public static function doSelectJoinAffiliateUser(Criteria $c, $con = null)
	{
		...
		$startcol = (AffiliateUserGroupPeer::NUM_COLUMNS - AffiliateUserGroupPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		AffiliateUserPeer::addSelectColumns($c);

		$c->addJoin(AffiliateUserGroupPeer::USERID, AffiliateUserPeer::ID);
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					...
					$temp_obj2->addAffiliateUserGroup($obj1); //CHECKME
					break;
				}
			}
			if ($newObject) {
				$obj2->initAffiliateUserGroups();
				$obj2->addAffiliateUserGroup($obj1); //CHECKME
			}
			$results[] = $obj1;
		}
		return $results;
	...
	public static function doSelectJoinAffiliateGroup(Criteria $c, $con = null)
	{
		...
		$c->addJoin(AffiliateUserGroupPeer::GROUPID, AffiliateGroupPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		AffiliateUserGroupPeer::addSelectColumns($c);
		$startcol2 = (AffiliateUserGroupPeer::NUM_COLUMNS - AffiliateUserGroupPeer::NUM_LAZY_LOAD_COLUMNS) + 1;

		AffiliateUserPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + AffiliateUserPeer::NUM_COLUMNS;

		AffiliateGroupPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + AffiliateGroupPeer::NUM_COLUMNS;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getAffiliateGroup(); // CHECKME
				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addAffiliateUserGroup($obj1); // CHECKME
					break;
				}
			}

			if ($newObject) {
				$obj3->initAffiliateUserGroups();
	...
	public static function doSelectJoinAllExceptAffiliateUser(Criteria $c, $con = null)
	{
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				...
				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
					$temp_obj2->addAffiliateUserGroup($obj1);
					break;
				}
			}
	 ...
	 */
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(AffiliateUserGroupPeer::USERID, $vals[0], Criteria::IN);
			$criteria->add(AffiliateUserGroupPeer::GROUPID, $vals[1], Criteria::IN);
		}
...
if (Propel::isInit()) {
	...
	try {
		BaseAffiliateUserGroupPeer::getMapBuilder();
	} catch (Exception $e) {
	...
	require_once 'anmaga/map/AffiliateUserGroupMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.AffiliateUserGroupMapBuilder');
}
