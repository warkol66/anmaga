...
include_once 'anmaga/PurchaseOrderItemPeer.php';
...
abstract class BasePurchaseOrderItem extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->productid = $rs->getInt($startcol + 1);

			$this->supplierpurchaseorderid = $rs->getInt($startcol + 2);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aSupplierPurchaseOrder !== null) {
				if ($this->aSupplierPurchaseOrder->isModified()) {
	 ...
	 * @throws     PropelException
	 */
	public function setSupplierPurchaseOrder($v)
	{
	 ...
	 * @throws     PropelException
	 */
	public function getSupplierPurchaseOrder($con = null)
	{
		// include the related Peer class
		...
		if ($this->aSupplierPurchaseOrder === null && ($this->supplierpurchaseorderid !== null)) {
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = SupplierPurchaseOrderPeer::retrieveByPK($this->supplierpurchaseorderid, $con);
			   $obj->addSupplierPurchaseOrders($this);
			 */
		}
