...
include_once 'anmaga/AffiliateGroup.php';
...
abstract class BaseAffiliateGroupPeer {
	...
	const CLASS_DEFAULT = 'anmaga.AffiliateGroup';
	...
	{
		include_once 'anmaga/map/AffiliateGroupMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.AffiliateGroupMapBuilder');
	}
	/**
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/AffiliateGroupMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.AffiliateGroupMapBuilder');
}
