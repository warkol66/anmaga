...
abstract class BaseProductRequest extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the icotermid field.
	 * @var        int
	 */
	protected $icotermid;
	...
	/**
	 * Get the [icotermid] column value.
	 * Icoterm
	 * @return     int
	 */
	public function getIcotermid()
	{

		return $this->icotermid;
	}
	...
	/**
	 * Set the value of [icotermid] column.
	 * Icoterm
	 * @param      int $v new value
	 * @return     void
	 */
	public function setIcotermid($v)
	{
		...
		if ($this->icotermid !== $v) {
			$this->icotermid = $v;
			$this->modifiedColumns[] = ProductRequestPeer::ICOTERMID;
		}

		if ($this->aIcoterm !== null && $this->aIcoterm->getId() !== $v) {
			$this->aIcoterm = null;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->icotermid = $rs->getInt($startcol + 9);
	...
	protected function doSave($con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aIcoterm !== null) {
				if ($this->aIcoterm->isModified()) {
					$affectedRows += $this->aIcoterm->save($con);
				}
				$this->setIcoterm($this->aIcoterm);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aIcoterm !== null) {
				if (!$this->aIcoterm->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aIcoterm->getValidationFailures());
				}
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductRequestPeer::ICOTERMID)) $criteria->add(ProductRequestPeer::ICOTERMID, $this->icotermid);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIcotermid($this->icotermid);
	...
	/**
	 * Declares an association between this object and a Icoterm object.
	 *
	 * @param      Icoterm $v
	 * @return     void
	 * @throws     PropelException
	 */
	public function setIcoterm($v)
	{


		if ($v === null) {
			$this->setIcotermid(NULL);
		} else {
			$this->setIcotermid($v->getId());
		}
	...
	/**
	 * Get the associated Icoterm object
	 *
	 * @param      Connection Optional Connection object.
	 * @return     Icoterm The associated Icoterm object.
	 * @throws     PropelException
	 */
	public function getIcoterm($con = null)
	{
		// include the related Peer class
		include_once 'anmaga/om/BaseIcotermPeer.php';

		if ($this->aIcoterm === null && ($this->icotermid !== null)) {

			$this->aIcoterm = IcotermPeer::retrieveByPK($this->icotermid, $con);
			...
			/* The following can be used instead of the line above to
			   ...
			   As it can lead to a db query with many results that may
			   never be used.
			   $obj = IcotermPeer::retrieveByPK($this->icotermid, $con);
			   $obj->addIcoterms($this);
			 */
		}
		return $this->aIcoterm;
	}
