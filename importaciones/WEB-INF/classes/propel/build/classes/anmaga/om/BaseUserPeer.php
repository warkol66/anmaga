...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'anmaga.User';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::PASSWORD, UserPeer::ACTIVE, UserPeer::CREATED, UserPeer::UPDATED, UserPeer::LEVELID, UserPeer::LASTLOGIN, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::PASSWORD => 2, UserPeer::ACTIVE => 3, UserPeer::CREATED => 4, UserPeer::UPDATED => 5, UserPeer::LEVELID => 6, UserPeer::LASTLOGIN => 7, ),
	...
	{
		include_once 'anmaga/map/UserMapBuilder.php';
		return BasePeer::getMapBuilder('anmaga.map.UserMapBuilder');
	}
	/**
	...
	protected static function doOnDeleteCascade(Criteria $criteria, Connection $con)
	{
		...
		foreach($objects as $obj) {
			...
			// delete related SupplierUser objects
			$c = new Criteria();
			
			$c->add(SupplierUserPeer::USERID, $obj->getId());
			$affectedRows += SupplierUserPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
if (Propel::isInit()) {
	...
	require_once 'anmaga/map/UserMapBuilder.php';
	Propel::registerMapBuilder('anmaga.map.UserMapBuilder');
}
