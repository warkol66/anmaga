...
abstract class BaseAffiliateUser extends BaseObject  implements Persistent {
		...
		if ($this->collProductRequestConfirmations === null) {
			if ($this->isNew()) {
			   $this->collProductRequestConfirmations = array();
				...
				$criteria->add(ProductRequestConfirmationPeer::USERID, $this->getId());
	 ...
	 * actually need in AffiliateUser.
	 */
	public function getProductRequestConfirmationsJoinProductRequest($criteria = null, $con = null)
	{
		// include the Peer class
		include_once 'anmaga/om/BaseProductRequestConfirmationPeer.php';
		if ($criteria === null) {
		...
		if ($this->collProductRequestConfirmations === null) {
			if ($this->isNew()) {
				...
				$this->collProductRequestConfirmations = ProductRequestConfirmationPeer::doSelectJoinProductRequest($criteria, $con);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
