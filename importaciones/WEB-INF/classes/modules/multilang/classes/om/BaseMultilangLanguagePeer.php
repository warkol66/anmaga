...
abstract class BaseMultilangLanguagePeer {
	...
	const NAME = 'multilang_language.NAME';
	 ...
	 * @param      string $column The column name for current table. (i.e. MultilangLanguagePeer::COLUMN_NAME).
	 * @return     string
	 */
	public static function alias($alias, $column)
	{
		return str_replace(MultilangLanguagePeer::TABLE_NAME.'.', $alias.'.', $column);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		$criteria->setPrimaryTableName(MultilangLanguagePeer::TABLE_NAME);
	...
	public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
	{
		...
		$critcopy->setLimit(1);
		$objects = MultilangLanguagePeer::doSelect($critcopy, $con);
		if ($objects) {
			return $objects[0];
		}
		return null;
	...
	{
		return MultilangLanguagePeer::populateObjects(MultilangLanguagePeer::doSelectStmt($criteria, $con));
	}
	/**
	 ...
	 *
	 * @param      mixed $value A MultilangLanguage object or a primary key value.
	 */
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof MultilangLanguage) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
				// assume we've been passed a primary key
				$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or MultilangLanguage object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	 ...
	 * @return     MultilangLanguage Found object or NULL if 1) no instance exists for specified key or 2) instance pooling has been disabled.
	...
	/**
	 * Method perform an INSERT on the database, given a MultilangLanguage or Criteria object.
	 *
	 * @param      mixed $values Criteria or MultilangLanguage object containing data that is used to create the INSERT statement.
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$criteria = $values->buildCriteria(); // build Criteria from MultilangLanguage object
		}

		if ($criteria->containsKey(MultilangLanguagePeer::ID) && $criteria->keyContainsValue(MultilangLanguagePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.MultilangLanguagePeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a MultilangLanguage or Criteria object.
	 *
	 * @param      mixed $values Criteria or MultilangLanguage object containing data that is used to create the UPDATE statement.
	...
	/**
	 * Method to DELETE all rows from the multilang_language table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a MultilangLanguage or Criteria object OR a primary key value.
	 *
	 * @param      mixed $values Criteria or MultilangLanguage object or primary key or array of primary keys
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = MultilangLanguagePeer::doSelect($criteria, $con);
	...
	/**
	 * Validates all modified columns of given MultilangLanguage object.
	 * If parameter $columns is either a single column name or an array of column names
	 * than only those columns are validated.
	 *
	 * NOTICE: This does not apply to primary or foreign keys for now.
	 *
	 * @param      MultilangLanguage $obj The object to validate.
	...
	public static function doValidate(MultilangLanguage $obj, $cols = null)
	{
		...
		if ($cols) {
			$dbMap = Propel::getDatabaseMap(MultilangLanguagePeer::DATABASE_NAME);
			$tableMap = $dbMap->getTable(MultilangLanguagePeer::TABLE_NAME);
		...
		return BasePeer::doValidate(MultilangLanguagePeer::DATABASE_NAME, MultilangLanguagePeer::TABLE_NAME, $columns);
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = MultilangLanguagePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria = new Criteria(MultilangLanguagePeer::DATABASE_NAME);
		$criteria->add(MultilangLanguagePeer::ID, $pk);

		$v = MultilangLanguagePeer::doSelect($criteria, $con);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(MultilangLanguagePeer::DATABASE_NAME);
			$criteria->add(MultilangLanguagePeer::ID, $pks, Criteria::IN);
			$objs = MultilangLanguagePeer::doSelect($criteria, $con);
		}
		return $objs;
	}
