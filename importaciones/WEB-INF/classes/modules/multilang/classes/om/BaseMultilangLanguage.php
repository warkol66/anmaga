...
abstract class BaseMultilangLanguage extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseMultilangLanguage object.
	 * @see        applyDefaults()
	 */
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = MultilangLanguagePeer::doInsert($this, $con);
	 ...
	 * Otherwise if this MultilangLanguage has previously been saved, it will retrieve
	 * related MultilangTexts from storage. If this MultilangLanguage is new, it will return
