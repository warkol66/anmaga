...
|-elseif $message eq "errorUpdate"-|
	<div class='failureMessage'>##182,Ha ocurrido un error al intentar guardar la información del grupo de usuarios##</div>
|-elseif $message eq "saved"-|
	<div class='successMessage'>##183,Grupo de Usuarios guardado##</div>
|-elseif $message eq "blankName"-|
	<div class='failureMessage'>##184,El Grupo de Usuarios debe tener un Nombre##</div>
|-elseif $message eq "notAddedToGroup"-|
	<div class='failureMessage'>##185,Ha ocurrido un error al intentar agregar la categoría al grupo##</div>
|-elseif $message eq "notRemovedFromGroup"-|
	<div class='failureMessage'>##186,Ha ocurrido un error al intentar eliminar la categoría del grupo##</div>
|-/if-|
|-if $accion eq "edicion"-|
...
<form method='post' action='Main.php?do=usersGroupsDoEdit'>
	...
	<p>##187,Editar nombre del Grupo ##</p>
	<p><label for="name">##196,Nombre##</label>
			<input name='name' type='text'  class='textodato' value='|-$currentGroup->getName()-|' size="45" />
	</p>
...
<table class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'>
	<tr>
		<th colspan="2">##188,El grupo## |-$currentGroup->getName()-| ##189,tiene acceso a las siguientes categorías:##</th>
	</tr>
	|-if $currentGroupCategories|@count eq 0-|
		<tr>
			<td colspan="2">##190,El grupo todavía no posee acceso a ninguna categoría.##</td>
		</tr>
		|-else-|
		<tr>
			<th width="98%">##191,Categorías##</th>
			<th width="2%">&nbsp;</th>
		</tr>
...
<table class='tableTdBorders' cellpadding='5' cellspacing='0' width='100%'>
	<tr>
		<th width="98%">##194,Grupo de Usuarios del Sistema##</th>
		<th width="2%">&nbsp;</th>
	</tr>
	|-foreach from=$groups item=group name=for_groups-|
	<tr>
		<td>|-$group->getName()-|</td>
		<td nowrap><a href='Main.php?do=usersGroupsList&group=|-$group->getId()-|' alt='##114,Editar##' title='##114,Editar##'><img src="images/clear.png" class="linkImageEdit"></a>
		|-if $group->getId() lt 4 -|
		...
		|-else-|
			<a href='Main.php?do=usersGroupsDoDelete&group=|-$group->getId()-|' title='##115,Eliminar##' alt='##115,Eliminar##' onclick="return confirm('##256,Esta opción eliminar permanentemente a este Grupo. ¿Está seguro que desea eliminarlo?##');"><img src="images/clear.png" class="linkImageDelete"></a>
		|-/if-|</td>
	</tr>
	|-/foreach-|
	<tr>
