...
class	SecurityActionNoCheckLoginDoSaveAction extends BaseAction {


	// ----- Constructor ---------------------------------------------------- //

	function SecurityActionNoCheckLoginDoSaveAction() {
		;
	}
	...
	*/
    ...
    BaseAction::execute($mapping, $form, $request, $response);
		...
		$actionsCheckeds = $_POST["noCheckLogin"];

		foreach ($actions as  $action) {
			$noCheckLogin = false;
			if (!empty($actionsCheckeds[$action]))
				$noCheckLogin = true;
