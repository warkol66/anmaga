...
/**
 * This class adds structure of 'import_clientPurchaseOrderItem' table to 'application' DatabaseMap object.
 *
 *
 *
 ...
 */
class ClientPurchaseOrderItemMapBuilder implements MapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'import.classes.map.ClientPurchaseOrderItemMapBuilder';
	...
	{
		$this->dbMap = Propel::getDatabaseMap(ClientPurchaseOrderItemPeer::DATABASE_NAME);

		$tMap = $this->dbMap->addTable(ClientPurchaseOrderItemPeer::TABLE_NAME);
		$tMap->setPhpName('ClientPurchaseOrderItem');
		$tMap->setClassname('ClientPurchaseOrderItem');
