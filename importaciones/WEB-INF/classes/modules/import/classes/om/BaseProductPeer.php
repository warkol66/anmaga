...
abstract class BaseProductPeer {
	...
	const ID = 'import_product.ID';

	/** the column name for the CODE field */
	const CODE = 'import_product.CODE';

	/** the column name for the NAME field */
	const NAME = 'import_product.NAME';

	/** the column name for the NAMESPANISH field */
	const NAMESPANISH = 'import_product.NAMESPANISH';

	/** the column name for the DESCRIPTION field */
	const DESCRIPTION = 'import_product.DESCRIPTION';

	/** the column name for the DESCRIPTIONSPANISH field */
	const DESCRIPTIONSPANISH = 'import_product.DESCRIPTIONSPANISH';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Code', 'Name', 'Namespanish', 'Description', 'Descriptionspanish', 'Active', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'code', 'name', 'namespanish', 'description', 'descriptionspanish', 'active', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CODE, self::NAME, self::NAMESPANISH, self::DESCRIPTION, self::DESCRIPTIONSPANISH, self::ACTIVE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'name', 'nameSpanish', 'description', 'descriptionSpanish', 'active', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Code' => 1, 'Name' => 2, 'Namespanish' => 3, 'Description' => 4, 'Descriptionspanish' => 5, 'Active' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'namespanish' => 3, 'description' => 4, 'descriptionspanish' => 5, 'active' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CODE => 1, self::NAME => 2, self::NAMESPANISH => 3, self::DESCRIPTION => 4, self::DESCRIPTIONSPANISH => 5, self::ACTIVE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'nameSpanish' => 3, 'description' => 4, 'descriptionSpanish' => 5, 'active' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	/**
	 * Method to DELETE all rows from the import_product table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
