...
abstract class BaseSupplierQuoteItemComment extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseSupplierQuoteItemComment object.
	 * @see        applyDefaults()
	 */
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			SupplierQuoteItemCommentPeer::doDelete($this, $con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SupplierQuoteItemCommentPeer::doInsert($this, $con);
	...
	public function getSupplierQuoteItem(PropelPDO $con = null)
	{
		if ($this->aSupplierQuoteItem === null && ($this->supplierquoteitemid !== null)) {
			$this->aSupplierQuoteItem = SupplierQuoteItemPeer::retrieveByPK($this->supplierquoteitemid, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
