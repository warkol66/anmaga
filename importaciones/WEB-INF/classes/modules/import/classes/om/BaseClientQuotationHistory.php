...
/**
 * Base class that represents a row from the 'import_clientQuotationHistory' table.
 *
 * Historial de Cotizacion a Cliente
 *
 * @package    import.classes.om
 */
abstract class BaseClientQuotationHistory extends BaseObject  implements Persistent {
	 ...
	 * @var        ClientQuotationHistoryPeer
	 */
	...
	/**
	 * Initializes internal state of BaseClientQuotationHistory object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ClientQuotationHistory The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = ClientQuotationHistoryPeer::ID;
		}
	...
	public function setClientquotationid($v)
	{
		...
		if ($this->clientquotationid !== $v) {
			...
			$this->modifiedColumns[] = ClientQuotationHistoryPeer::CLIENTQUOTATIONID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = ClientQuotationHistoryPeer::STATUS;
		}
	...
	public function setCreatedat($v)
	{
		...
		if ( $this->createdat !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = ClientQuotationHistoryPeer::CREATEDAT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ClientQuotationHistoryPeer::NUM_COLUMNS - ClientQuotationHistoryPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating ClientQuotationHistory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ClientQuotationHistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			ClientQuotationHistoryPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			ClientQuotationHistoryPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = ClientQuotationHistoryPeer::doInsert($this, $con);
					...
					$affectedRows += ClientQuotationHistoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ClientQuotationHistoryPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientQuotationHistoryPeer::ID)) $criteria->add(ClientQuotationHistoryPeer::ID, $this->id);
		if ($this->isColumnModified(ClientQuotationHistoryPeer::CLIENTQUOTATIONID)) $criteria->add(ClientQuotationHistoryPeer::CLIENTQUOTATIONID, $this->clientquotationid);
		if ($this->isColumnModified(ClientQuotationHistoryPeer::STATUS)) $criteria->add(ClientQuotationHistoryPeer::STATUS, $this->status);
		if ($this->isColumnModified(ClientQuotationHistoryPeer::CREATEDAT)) $criteria->add(ClientQuotationHistoryPeer::CREATEDAT, $this->createdat);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(ClientQuotationHistoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ClientQuotationHistory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ClientQuotationHistory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ClientQuotationHistoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ClientQuotationHistoryPeer();
		}
		return self::$peer;
	}
	...
	public function setClientQuotation(ClientQuotation $v = null)
	{
		...
		if ($v !== null) {
			$v->addClientQuotationHistory($this);
		}
	...
	public function getClientQuotation(PropelPDO $con = null)
	{
		if ($this->aClientQuotation === null && ($this->clientquotationid !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aClientQuotation->addClientQuotationHistorys($this);
			 */
		}
