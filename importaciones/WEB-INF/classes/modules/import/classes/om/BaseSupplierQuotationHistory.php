...
/**
 * Base class that represents a row from the 'import_supplierQuotationHistory' table.
 *
 * Historial de Cotizacion a Proveedor
 *
 * @package    import.classes.om
 */
abstract class BaseSupplierQuotationHistory extends BaseObject  implements Persistent {
	 ...
	 * @var        SupplierQuotationHistoryPeer
	 */
	...
	/**
	 * Initializes internal state of BaseSupplierQuotationHistory object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     SupplierQuotationHistory The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = SupplierQuotationHistoryPeer::ID;
		}
	...
	public function setSupplierquotationid($v)
	{
		...
		if ($this->supplierquotationid !== $v) {
			...
			$this->modifiedColumns[] = SupplierQuotationHistoryPeer::SUPPLIERQUOTATIONID;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v) {
			$this->status = $v;
			$this->modifiedColumns[] = SupplierQuotationHistoryPeer::STATUS;
		}
	...
	public function setCreatedat($v)
	{
		...
		if ( $this->createdat !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = SupplierQuotationHistoryPeer::CREATEDAT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = SupplierQuotationHistoryPeer::NUM_COLUMNS - SupplierQuotationHistoryPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SupplierQuotationHistory object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SupplierQuotationHistoryPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			SupplierQuotationHistoryPeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			SupplierQuotationHistoryPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SupplierQuotationHistoryPeer::doInsert($this, $con);
					...
					$affectedRows += SupplierQuotationHistoryPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SupplierQuotationHistoryPeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SupplierQuotationHistoryPeer::ID)) $criteria->add(SupplierQuotationHistoryPeer::ID, $this->id);
		if ($this->isColumnModified(SupplierQuotationHistoryPeer::SUPPLIERQUOTATIONID)) $criteria->add(SupplierQuotationHistoryPeer::SUPPLIERQUOTATIONID, $this->supplierquotationid);
		if ($this->isColumnModified(SupplierQuotationHistoryPeer::STATUS)) $criteria->add(SupplierQuotationHistoryPeer::STATUS, $this->status);
		if ($this->isColumnModified(SupplierQuotationHistoryPeer::CREATEDAT)) $criteria->add(SupplierQuotationHistoryPeer::CREATEDAT, $this->createdat);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SupplierQuotationHistoryPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SupplierQuotationHistory (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SupplierQuotationHistory Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SupplierQuotationHistoryPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SupplierQuotationHistoryPeer();
		}
		return self::$peer;
	}
	...
	public function setSupplierQuotation(SupplierQuotation $v = null)
	{
		...
		if ($v !== null) {
			$v->addSupplierQuotationHistory($this);
		}
	...
	public function getSupplierQuotation(PropelPDO $con = null)
	{
		if ($this->aSupplierQuotation === null && ($this->supplierquotationid !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aSupplierQuotation->addSupplierQuotationHistorys($this);
			 */
		}
