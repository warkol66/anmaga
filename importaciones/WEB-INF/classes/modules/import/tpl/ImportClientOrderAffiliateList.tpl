			...
			<tr>
				...
				<td nowrap="nowrap">
					<form action="Main.php" method="get">						
						...
						<input type="submit" name="submit_go_edit_order" value="Editar" class="buttonImageEdit" />
					</form>
					<form action="Main.php" method="get">						
						<input type="hidden" name="do" value="importClientOrderHistory" />
						<input type="hidden" name="id" value="|-$order->getid()-|" />
						<input type="submit" name="submit_go_edit_order" value="Ver Historial" class="buttonImageHistory" />
					</form>
