			...
			<tr valign="top">
				...
				<td nowrap="nowrap">
					...
					<form action="Main.php" method="get">						
						...
						<input type="hidden" name="id" value="|-$order->getid()-|" />
						<input type="button" name="submit_go_edit_order" value="Ver Historial" class="buttonImageHistory" title="Ver Historial" alt="Ver Historial" onClick="window.open('Main.php?do=importSupplierOrderHistory&id=|-$quote->getid()-|','History','width=670,height=500,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');" />
					</form>
				</td>
			</tr>
		|-/foreach-|						
