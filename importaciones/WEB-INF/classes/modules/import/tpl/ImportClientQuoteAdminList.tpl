			...
			<tr valign="top">
				...
				<td nowrap="nowrap">
					...
					<form action="Main.php" method="get">						
						...
						<input type="hidden" name="id" value="|-$quote->getid()-|" />
						<input type="submit" name="submit_go_edit_quote" value="Ver Historial" class="buttonImageHistory" title="Ver Historial" alt="Ver Historial" onClick="window.open('Main.php?do=importClientQuoteHistory&id=|-$quote->getid()-|','History','width=670,height=500,menubar=no,status=no,location=no,toolbar=no,scrollbars=yes');" />
					</form>
<!--					<form action="Main.php" method="post">
