...
|-foreach from=$result item=item-|
	<li>
		|-if $item.type neq 2-|
			|-if $item.id neq $contentData.id-|<a href="Main.php?do=contentShow&id=|-$item.id-|">|-$item.titleInMenu-|</a>|-else-|<span class="current">|-$item.titleInMenu-|</span>|-/if-|
		|-else-|
			|-if $item.id neq $contentData.id-|<a href="|-$item.link-|" target="_blank">|-$item.titleInMenu-|</a>|-else-|<span class="current">|-$item.titleInMenu-|</span>|-/if-|
		|-/if-|
