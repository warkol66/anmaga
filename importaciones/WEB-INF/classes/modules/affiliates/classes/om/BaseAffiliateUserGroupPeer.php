...
abstract class BaseAffiliateUserGroupPeer {
	...
	/**
	 * Method perform an INSERT on the database, given a AffiliateUserGroup or Criteria object.
	 *
	...
	/**
	 * Method perform an UPDATE on the database, given a AffiliateUserGroup or Criteria object.
	 *
	...
	/**
	 * Method to DELETE all rows from the affiliates_userGroup table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a AffiliateUserGroup or Criteria object OR a primary key value.
	 *
